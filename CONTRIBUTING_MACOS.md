...
The base instructions to set up the development environment are located in [CONTRIBUTING.md](https://github.com/callosum-dot-app/callosum/blob/main/CONTRIBUTING.md).
