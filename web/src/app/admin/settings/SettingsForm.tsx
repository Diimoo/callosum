  ...
  return (
    <div className="flex flex-col pb-8">
      ...
      <Checkbox
        ...
        sublabel="If set, users will not be required to sign in to use Callosum."
          ...
          <Modal.Content medium>
            ...
            <Modal.Body>
              <p>
                ...
                anyone to use Callosum without signing in.
              </p>
            </Modal.Body>
      ...
      {isEnterpriseEnabled && (
        <>
          ...
          <IntegerInput
            ...
            sublabel="Enter the maximum number of days you would like Callosum to retain chat messages. Leaving this field empty will cause Callosum to never delete chat messages."
