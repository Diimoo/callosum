              ...
              <div className="flex flex-col gap-4">
                <div>
                  ...
                  <InputTypeIn
                    ...
                    placeholder="Set how Callosum should refer to you"
                    className="mt-2"
                  />
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <SubLabel>
                      Allow Callosum to reference stored memories in future chats.
                    </SubLabel>
                  </div>
                  <Switch
                    ...
                    <div className="max-h-64 overflow-y-auto flex flex-col gap-3 pr-1">
                      {personalizationValues.memories.map((memory, index) => (
                        <InputTextArea
                          key={index}
                          value={memory}
                          placeholder="Write something Callosum should remember"
                          onChange={(event) =>
