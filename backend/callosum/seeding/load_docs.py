...
from callosum.access.models import default_public_access
from callosum.configs.constants import DEFAULT_BOOST
from callosum.configs.constants import DocumentSource
from callosum.configs.constants import KV_DOCUMENTS_SEEDED_KEY
from callosum.configs.constants import RETURN_SEPARATOR
from callosum.configs.model_configs import DEFAULT_DOCUMENT_ENCODER_MODEL
...
from callosum.db.credentials import PUBLIC_CREDENTIAL_ID
...
from callosum.db.index_attempt import mock_successful_index_attempt
...
from callosum.indexing.indexing_pipeline import index_doc_batch_prepare
from callosum.indexing.models import ChunkEmbedding
...
def seed_initial_documents(
    ...
    connector_data = ConnectorBase(
        ...
        connector_specific_config={
            "base_url": "https://docs.callosum.app/more/use_cases",
