...
from callosum.configs.chat_configs import ENABLE_CONNECTOR_CLASSIFIER
...
from callosum.prompts.constants import SOURCES_KEY
from callosum.prompts.filter_extration import FILE_SOURCE_WARNING
from callosum.prompts.filter_extration import SOURCE_FILTER_PROMPT
from callosum.prompts.filter_extration import WEB_SOURCE_WARNING
...
def extract_source_filter(
    ...
    def _get_source_filter_messages(
        ...
        messages = [
            ...
            {
                "role": "user",
                "content": "What page from Callosum contains debugging instruction on segfault",
            },
            {
                "role": "assistant",
                "content": json.dumps({SOURCES_KEY: None}),
...
if __name__ == "__main__":
    from callosum.llm.factory import get_default_llms, get_main_llm_from_tuple
