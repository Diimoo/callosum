...
from callosum.chat.prompt_builder.utils import translate_callosum_msg_to_langchain
...
from callosum.prompts.chat_prompts import AGGRESSIVE_SEARCH_TEMPLATE
from callosum.prompts.chat_prompts import NO_SEARCH
from callosum.prompts.chat_prompts import REQUIRE_SEARCH_HINT
from callosum.prompts.chat_prompts import REQUIRE_SEARCH_SYSTEM_MSG
from callosum.prompts.chat_prompts import SKIP_SEARCH
...
def check_if_need_search_multi_message(
    ...
    prompt_msgs.extend([translate_callosum_msg_to_langchain(msg) for msg in history])
