...
from callosum.chat.prune_and_merge import _merge_sections
from callosum.chat.prune_and_merge import ChunkRange
from callosum.chat.prune_and_merge import merge_chunk_intervals
from callosum.configs.chat_configs import DISABLE_LLM_DOC_RELEVANCE
...
from callosum.context.search.models import RerankMetricsContainer
from callosum.context.search.models import RetrievalMetricsContainer
from callosum.context.search.models import SearchQuery
from callosum.context.search.models import SearchRequest
from callosum.context.search.postprocessing.postprocessing import cleanup_chunks
from callosum.context.search.postprocessing.postprocessing import search_postprocessing
from callosum.context.search.preprocessing.preprocessing import retrieval_preprocessing
from callosum.context.search.retrieval.search_runner import retrieve_chunks
from callosum.context.search.utils import inference_section_from_chunks
...
from callosum.secondary_llm_flows.agentic_evaluation import evaluate_inference_section
from callosum.utils.logger import setup_logger
from callosum.utils.threadpool_concurrency import FunctionCall
from callosum.utils.threadpool_concurrency import run_functions_in_parallel
...
class SearchPipeline:
    ...
    def _get_sections(self) -> list[InferenceSection]:
        ...
        censored_chunks = fetch_ee_implementation_or_noop(
            "callosum.external_permissions.post_query_censoring",
