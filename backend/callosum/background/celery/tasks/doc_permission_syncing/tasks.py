...
from ee.callosum.external_permissions.sync_params import DOC_PERMISSION_SYNC_PERIODS
from ee.callosum.external_permissions.sync_params import DOC_PERMISSIONS_FUNC_MAP
...
@shared_task(
    name=CallosumCeleryTask.UPDATE_EXTERNAL_DOCUMENT_PERMISSIONS_TASK,
