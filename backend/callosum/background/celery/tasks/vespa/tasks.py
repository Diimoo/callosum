...
from callosum.access.access import get_access_for_document
from callosum.background.celery.apps.app_base import task_logger
from callosum.background.celery.celery_redis import celery_get_queue_length
from callosum.background.celery.celery_redis import celery_get_unacked_task_ids
from callosum.background.celery.tasks.shared.RetryDocumentIndex import RetryDocumentIndex
from callosum.background.celery.tasks.shared.tasks import LIGHT_SOFT_TIME_LIMIT
from callosum.background.celery.tasks.shared.tasks import LIGHT_TIME_LIMIT
from callosum.configs.app_configs import JOB_TIMEOUT
from callosum.configs.app_configs import VESPA_SYNC_MAX_TASKS
from callosum.configs.constants import CELERY_VESPA_SYNC_BEAT_LOCK_TIMEOUT
...
from callosum.db.connector import mark_cc_pair_as_permissions_synced
from callosum.db.connector import mark_ccpair_as_pruned
from callosum.db.connector_credential_pair import add_deletion_failure_message
...
from callosum.db.connector_credential_pair import get_connector_credential_pairs
from callosum.db.document import count_documents_by_needs_sync
from callosum.db.document import get_document
from callosum.db.document import get_document_ids_for_connector_credential_pair
from callosum.db.document import mark_document_as_synced
from callosum.db.document_set import delete_document_set
from callosum.db.document_set import delete_document_set_cc_pair_relationship__no_commit
from callosum.db.document_set import fetch_document_sets
from callosum.db.document_set import fetch_document_sets_for_document
from callosum.db.document_set import get_document_set_by_id
from callosum.db.document_set import mark_document_set_as_synced
from callosum.db.engine import get_session_with_tenant
from callosum.db.enums import IndexingStatus
from callosum.db.enums import SyncStatus
from callosum.db.enums import SyncType
from callosum.db.index_attempt import delete_index_attempts
...
from callosum.db.models import UserGroup
from callosum.db.sync_record import cleanup_sync_records
from callosum.db.sync_record import insert_sync_record
from callosum.db.sync_record import update_sync_record_status
from callosum.document_index.document_index_utils import get_both_index_names
from callosum.document_index.factory import get_default_document_index
from callosum.document_index.interfaces import VespaDocumentFields
from callosum.redis.redis_connector import RedisConnector
from callosum.redis.redis_connector_credential_pair import RedisConnectorCredentialPair
from callosum.redis.redis_connector_delete import RedisConnectorDelete
from callosum.redis.redis_connector_doc_perm_sync import RedisConnectorPermissionSync
from callosum.redis.redis_connector_doc_perm_sync import (
    RedisConnectorPermissionSyncPayload,
)
from callosum.redis.redis_connector_index import RedisConnectorIndex
from callosum.redis.redis_connector_prune import RedisConnectorPrune
from callosum.redis.redis_document_set import RedisDocumentSet
...
from callosum.redis.redis_usergroup import RedisUserGroup
...
from callosum.utils.variable_functionality import (
    fetch_versioned_implementation_with_fallback,
)
from callosum.utils.variable_functionality import global_version
from callosum.utils.variable_functionality import noop_fallback
...
@shared_task(
    name=CallosumCeleryTask.CHECK_FOR_VESPA_SYNC_TASK,
...
def check_for_vespa_sync_task(self: Task, *, tenant_id: str | None) -> bool | None:
    ...
    lock_beat: RedisLock = r.lock(
        CallosumRedisLocks.CHECK_VESPA_SYNC_BEAT_LOCK,
        ...
        if global_version.is_ee_version():
            ...
            try:
                fetch_user_groups = fetch_versioned_implementation(
                    "callosum.db.user_group", "fetch_user_groups"
                )
...
def try_generate_user_group_sync_tasks(
    ...
    fetch_user_group = cast(
        ...
        fetch_versioned_implementation("callosum.db.user_group", "fetch_user_group"),
    )
...
@shared_task(name=CallosumCeleryTask.MONITOR_VESPA_SYNC, soft_time_limit=300, bind=True)
def monitor_vespa_sync(self: Task, tenant_id: str | None) -> bool | None:
    ...
    lock_beat: RedisLock = r.lock(
        CallosumRedisLocks.MONITOR_VESPA_SYNC_BEAT_LOCK,
        timeout=CELERY_VESPA_SYNC_BEAT_LOCK_TIMEOUT,
    )
    ...
    try:
        ...
        if not MULTI_TENANT or random.randint(1, 10) == 10:
            ...
            n_indexing = celery_get_queue_length(
                CallosumCeleryQueues.CONNECTOR_INDEXING, r_celery
            )
            n_sync = celery_get_queue_length(
                CallosumCeleryQueues.VESPA_METADATA_SYNC, r_celery
            )
            n_deletion = celery_get_queue_length(
                CallosumCeleryQueues.CONNECTOR_DELETION, r_celery
            )
            n_pruning = celery_get_queue_length(
                CallosumCeleryQueues.CONNECTOR_PRUNING, r_celery
            )
            n_permissions_sync = celery_get_queue_length(
                CallosumCeleryQueues.CONNECTOR_DOC_PERMISSIONS_SYNC, r_celery
            )
            n_external_group_sync = celery_get_queue_length(
                CallosumCeleryQueues.CONNECTOR_EXTERNAL_GROUP_SYNC, r_celery
            )
            n_permissions_upsert = celery_get_queue_length(
                CallosumCeleryQueues.DOC_PERMISSIONS_UPSERT, r_celery
            )
        ...
        timings["queues_ttl"] = r.ttl(CallosumRedisLocks.MONITOR_VESPA_SYNC_BEAT_LOCK)
        ...
        timings["connector_ttl"] = r.ttl(CallosumRedisLocks.MONITOR_VESPA_SYNC_BEAT_LOCK)
        ...
        timings["documentset_ttl"] = r.ttl(CallosumRedisLocks.MONITOR_VESPA_SYNC_BEAT_LOCK)
        ...
        for key_bytes in r.scan_iter(
            ...
            monitor_usergroup_taskset = fetch_versioned_implementation_with_fallback(
                "callosum.background.celery.tasks.vespa.tasks",
        ...
        timings["usergroup_ttl"] = r.ttl(CallosumRedisLocks.MONITOR_VESPA_SYNC_BEAT_LOCK)
        ...
        timings["pruning_ttl"] = r.ttl(CallosumRedisLocks.MONITOR_VESPA_SYNC_BEAT_LOCK)
        ...
        timings["indexing_ttl"] = r.ttl(CallosumRedisLocks.MONITOR_VESPA_SYNC_BEAT_LOCK)
        ...
        timings["permissions_ttl"] = r.ttl(CallosumRedisLocks.MONITOR_VESPA_SYNC_BEAT_LOCK)
...
@shared_task(
    name=CallosumCeleryTask.VESPA_METADATA_SYNC_TASK,
    bind=True,
