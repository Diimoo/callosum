...
from callosum.db.engine import get_db_current_time
...
from callosum.db.index_attempt import create_index_attempt
from callosum.db.index_attempt import delete_index_attempt
from callosum.db.index_attempt import get_all_index_attempts_by_status
...
from callosum.redis.redis_connector_index import RedisConnectorIndexPayload
...
def validate_indexing_fence(
    ...
    found = celery_find_task(
        payload.celery_task_id, CallosumCeleryQueues.CONNECTOR_INDEXING, r_celery
    )
    if found:
...
def try_creating_indexing_task(
    ...
    try:
        ...
        result = celery_app.send_task(
            CallosumCeleryTask.CONNECTOR_INDEXING_PROXY_TASK,
            kwargs=dict(
            ...
            queue=CallosumCeleryQueues.CONNECTOR_INDEXING,
