...
from ee.callosum.configs.app_configs import SUPER_USERS
...
from callosum.db.auth import get_total_users_count
from callosum.db.engine import CURRENT_TENANT_ID_CONTEXTVAR
    ...
    if MULTI_TENANT:
        try:
            ...
            if isinstance(e.orig, UniqueViolation):
                raise HTTPException(
                    status_code=400,
                    detail="User has already been invited to a Callosum organization",
                )
            raise
