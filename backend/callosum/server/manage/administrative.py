...
from callosum.configs.app_configs import GENERATIVE_MODEL_ACCESS_CHECK_FREQ
from callosum.configs.constants import DocumentSource
from callosum.configs.constants import KV_GEN_AI_KEY_CHECK_TIME
from callosum.configs.constants import CallosumCeleryPriority
from callosum.configs.constants import CallosumCeleryTask
from callosum.db.connector_credential_pair import get_connector_credential_pair_for_user
...
from callosum.db.feedback import fetch_docs_ranked_by_boost_for_user
from callosum.db.feedback import update_document_boost_for_user
from callosum.db.feedback import update_document_hidden_for_user
from callosum.db.index_attempt import cancel_indexing_attempts_for_ccpair
...
from callosum.server.manage.models import BoostDoc
from callosum.server.manage.models import BoostUpdateRequest
from callosum.server.manage.models import HiddenUpdateRequest
...
def create_deletion_attempt_for_connector_id(
    ...
    primary_app.send_task(
        CallosumCeleryTask.CHECK_FOR_CONNECTOR_DELETION,
