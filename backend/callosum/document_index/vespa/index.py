...
from callosum.configs.chat_configs import DOC_TIME_DECAY
from callosum.configs.chat_configs import NUM_RETURNED_HITS
from callosum.configs.chat_configs import TITLE_CONTENT_RATIO
from callosum.configs.chat_configs import VESPA_SEARCHER_THREADS
from callosum.configs.constants import KV_REINDEX_KEY
from callosum.context.search.models import IndexFilters
from callosum.context.search.models import InferenceChunkUncleaned
from callosum.db.engine import get_session_with_tenant
from callosum.document_index.document_index_utils import get_document_chunk_ids
from callosum.document_index.interfaces import DocumentIndex
from callosum.document_index.interfaces import DocumentInsertionRecord
from callosum.document_index.interfaces import EnrichedDocumentIndexingInfo
from callosum.document_index.interfaces import IndexBatchParams
from callosum.document_index.interfaces import MinimalDocumentIndexingInfo
from callosum.document_index.interfaces import UpdateRequest
from callosum.document_index.interfaces import VespaChunkRequest
from callosum.document_index.interfaces import VespaDocumentFields
from callosum.document_index.vespa.chunk_retrieval import batch_search_api_retrieval
from callosum.document_index.vespa.chunk_retrieval import (
    parallel_visit_api_retrieval,
)
from callosum.document_index.vespa.chunk_retrieval import query_vespa
from callosum.document_index.vespa.deletion import delete_vespa_chunks
from callosum.document_index.vespa.indexing_utils import batch_index_vespa_chunks
from callosum.document_index.vespa.indexing_utils import check_for_final_chunk_existence
from callosum.document_index.vespa.indexing_utils import clean_chunk_id_copy
from callosum.document_index.vespa.indexing_utils import (
    get_multipass_config,
)
from callosum.document_index.vespa.shared_utils.utils import get_vespa_http_client
from callosum.document_index.vespa.shared_utils.utils import (
    replace_invalid_doc_id_characters,
)
from callosum.document_index.vespa.shared_utils.vespa_request_builders import (
    build_vespa_filters,
)
from callosum.document_index.vespa_constants import ACCESS_CONTROL_LIST
from callosum.document_index.vespa_constants import BATCH_SIZE
from callosum.document_index.vespa_constants import BOOST
from callosum.document_index.vespa_constants import CONTENT_SUMMARY
from callosum.document_index.vespa_constants import DANSWER_CHUNK_REPLACEMENT_PAT
from callosum.document_index.vespa_constants import DATE_REPLACEMENT
from callosum.document_index.vespa_constants import DOCUMENT_ID_ENDPOINT
from callosum.document_index.vespa_constants import DOCUMENT_REPLACEMENT_PAT
from callosum.document_index.vespa_constants import DOCUMENT_SETS
from callosum.document_index.vespa_constants import HIDDEN
from callosum.document_index.vespa_constants import NUM_THREADS
from callosum.document_index.vespa_constants import SEARCH_THREAD_NUMBER_PAT
from callosum.document_index.vespa_constants import TENANT_ID_PAT
from callosum.document_index.vespa_constants import TENANT_ID_REPLACEMENT
from callosum.document_index.vespa_constants import VESPA_APPLICATION_ENDPOINT
from callosum.document_index.vespa_constants import VESPA_DIM_REPLACEMENT_PAT
from callosum.document_index.vespa_constants import VESPA_TIMEOUT
from callosum.document_index.vespa_constants import YQL_BASE
from callosum.indexing.models import DocMetadataAwareIndexChunk
from callosum.key_value_store.factory import get_kv_store
from callosum.utils.batching import batch_generator
...
class VespaIndex(DocumentIndex):
    ...
    def ensure_indices_exist(
        ...
        vespa_schema_path = os.path.join(
            os.getcwd(), "callosum", "document_index", "vespa", "app_config"
        )
        ...
        if response.status_code != 200:
            raise RuntimeError(
                f"Failed to prepare Vespa Callosum Index. Response: {response.text}"
            )
    ...
    def register_multitenant_indices(
        ...
        if response.status_code != 200:
            raise RuntimeError(
                f"Failed to prepare Vespa Callosum Indexes. Response: {response.text}"
            )
