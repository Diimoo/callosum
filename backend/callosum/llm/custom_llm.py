...
from callosum.llm.utils import convert_lm_input_to_basic_string
...
class CustomModelServer(LLM):
    """This class is to provide an example for how to use Callosum
    ...
    def __init__(
        ...
        if not endpoint:
            raise ValueError(
                "Cannot point Callosum to a custom LLM server without providing the "
