...
from callosum.db.tools import get_tool_by_name
from callosum.deep_research.dr_mock_tools import get_clarification_tool_definitions
from callosum.deep_research.dr_mock_tools import get_orchestrator_tools
from callosum.deep_research.dr_mock_tools import RESEARCH_AGENT_DB_NAME
from callosum.deep_research.dr_mock_tools import RESEARCH_AGENT_TOOL_NAME
...
from callosum.deep_research.utils import create_think_tool_token_processor
...
from callosum.prompts.deep_research.orchestration_layer import CLARIFICATION_PROMPT
from callosum.prompts.deep_research.orchestration_layer import FINAL_REPORT_PROMPT
from callosum.prompts.deep_research.orchestration_layer import ORCHESTRATOR_PROMPT
from callosum.prompts.deep_research.orchestration_layer import ORCHESTRATOR_PROMPT_REASONING
from callosum.prompts.deep_research.orchestration_layer import RESEARCH_PLAN_PROMPT
from callosum.prompts.deep_research.orchestration_layer import USER_FINAL_REPORT_QUERY
...
from callosum.server.query_and_chat.streaming_models import DeepResearchPlanDelta
from callosum.server.query_and_chat.streaming_models import DeepResearchPlanStart
from callosum.server.query_and_chat.streaming_models import OverallStop
...
from callosum.server.query_and_chat.streaming_models import TopLevelBranching
from callosum.tools.fake_tools.research_agent import run_research_agent_calls
...
from callosum.tracing.framework.create import trace
...
def run_deep_research_llm_loop(
    ...
    with trace(
        ...
        from callosum.llm.litellm_singleton.config import initialize_litellm
