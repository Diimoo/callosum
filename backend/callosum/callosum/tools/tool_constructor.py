...
from callosum.auth.oauth_token_manager import OAuthTokenManager
from callosum.chat.emitter import Emitter
from callosum.configs.app_configs import AZURE_IMAGE_API_BASE
from callosum.configs.app_configs import AZURE_IMAGE_API_KEY
from callosum.configs.app_configs import AZURE_IMAGE_API_VERSION
from callosum.configs.app_configs import AZURE_IMAGE_DEPLOYMENT_NAME
from callosum.configs.app_configs import IMAGE_MODEL_NAME
from callosum.configs.model_configs import GEN_AI_TEMPERATURE
...
from callosum.db.mcp import get_all_mcp_tools_for_server
...
from callosum.db.oauth_config import get_oauth_config
...
from callosum.llm.interfaces import LLMConfig
from callosum.callosumbot.slack.models import SlackContext
from callosum.tools.built_in_tools import get_built_in_tool_by_id
from callosum.tools.interface import Tool
from callosum.tools.models import DynamicSchemaInfo
...
from callosum.tools.tool_implementations.mcp.mcp_tool import MCPTool
from callosum.tools.tool_implementations.open_url.open_url_tool import (
    OpenURLTool,
)
...
from callosum.tools.tool_implementations.web_search.web_search_tool import (
    WebSearchTool,
)
from callosum.utils.headers import header_dict_to_header_list
        ...
        if db_tool_model.in_code_tool_id:
            ...
            # Handle Web Search Tool
                ...
                try:
                    ...
                    raise ValueError(
                        "Internet search tool requires a search provider API key, please contact your Callosum admin to get it added!"
                    )
            ...
            # Handle Open URL Tool
                ...
                try:
                    ...
                    raise ValueError(
                        "Open URL tool requires a web content provider, please contact your Callosum admin to get it configured!"
                    )
