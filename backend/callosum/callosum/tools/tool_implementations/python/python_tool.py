...
from callosum.configs.app_configs import CODE_INTERPRETER_DEFAULT_TIMEOUT_MS
from callosum.configs.app_configs import CODE_INTERPRETER_MAX_OUTPUT_LENGTH
from callosum.configs.constants import FileOrigin
from callosum.file_store.utils import build_full_frontend_file_url
...
from callosum.tools.models import LlmPythonExecutionResult
from callosum.tools.models import PythonExecutionFile
from callosum.tools.models import PythonToolOverrideKwargs
from callosum.tools.models import ToolResponse
from callosum.tools.tool_implementations.python.code_interpreter_client import (
    CodeInterpreterClient,
)
from callosum.tools.tool_implementations.python.code_interpreter_client import FileInput
        ...
        try:
            ...
            for workspace_file in response.files:
                ...
                try:
                    ...
                    # Save to Callosum file store
                    callosum_file_id = file_store.save_file(
                    ...
                    generated_files.append(
                        PythonExecutionFile(
                            filename=filename,
                            file_link=build_full_frontend_file_url(callosum_file_id),
                        )
                    )
                    generated_file_ids.append(callosum_file_id)
