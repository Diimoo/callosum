...
from callosum.configs.app_configs import IMAGE_SUMMARIZATION_SYSTEM_PROMPT
from callosum.configs.app_configs import IMAGE_SUMMARIZATION_USER_PROMPT
from callosum.llm.interfaces import LLM
from callosum.llm.models import ChatCompletionMessage
from callosum.llm.models import ContentPart
