...
from callosum.configs.app_configs import MAX_SLACK_QUERY_EXPANSIONS
...
from callosum.prompts.federated_search import SLACK_DATE_EXTRACTION_PROMPT
from callosum.prompts.federated_search import SLACK_QUERY_EXPANSION_PROMPT
