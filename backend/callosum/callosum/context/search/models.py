...
from callosum.indexing.models import BaseChunk
from callosum.indexing.models import IndexingSetting
from callosum.tools.tool_implementations.web_search.models import WEB_SEARCH_PREFIX
...
class RetrievalDetails(ChunkContext):
    ...
    # Is this a real-time/streaming call or a question where Callosum can take more time?
