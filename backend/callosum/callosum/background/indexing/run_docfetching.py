...
from callosum.access.access import source_should_fetch_permissions_during_indexing
from callosum.background.indexing.checkpointing_utils import check_checkpoint_size
from callosum.background.indexing.checkpointing_utils import get_latest_valid_checkpoint
from callosum.background.indexing.checkpointing_utils import save_checkpoint
from callosum.background.indexing.memory_tracer import MemoryTracer
from callosum.configs.app_configs import INDEX_BATCH_SIZE
from callosum.configs.app_configs import INDEXING_SIZE_WARNING_THRESHOLD
from callosum.configs.app_configs import INDEXING_TRACER_INTERVAL
from callosum.configs.app_configs import INTEGRATION_TESTS_MODE
from callosum.configs.app_configs import LEAVE_CONNECTOR_ACTIVE_ON_INITIALIZATION_FAILURE
from callosum.configs.app_configs import MAX_FILE_SIZE_BYTES
...
from callosum.connectors.connector_runner import ConnectorRunner
from callosum.connectors.exceptions import ConnectorValidationError
from callosum.connectors.exceptions import UnexpectedValidationError
...
from callosum.db.connector_credential_pair import get_last_successful_attempt_poll_range_end
from callosum.db.connector_credential_pair import update_connector_credential_pair
from callosum.db.constants import CONNECTOR_VALIDATION_ERROR_MESSAGE_PREFIX
...
from callosum.db.index_attempt import get_recent_completed_attempts_for_cc_pair
from callosum.db.index_attempt import mark_attempt_canceled
from callosum.db.index_attempt import mark_attempt_failed
from callosum.db.index_attempt import transition_attempt_to_in_progress
...
def connector_document_extraction(
    ...
    with get_session_with_current_tenant() as db_session:
        ...
        docprocessing_priority = (
            CallosumCeleryPriority.MEDIUM
            if has_successful_attempt
            else CallosumCeleryPriority.HIGH
        )
    ...
    try:
        ...
        while checkpoint.has_more:
            ...
            for document_batch, failure, next_checkpoint in connector_runner.run(
                ...
                app.send_task(
                    CallosumCeleryTask.DOCPROCESSING_TASK,
                    kwargs=processing_batch_data,
                    queue=CallosumCeleryQueues.DOCPROCESSING,
...
def reissue_old_batches(
    ...
    priority: CallosumCeleryPriority,
) -> tuple[int, int]:
