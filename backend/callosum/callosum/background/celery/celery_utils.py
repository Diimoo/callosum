...
from callosum.configs.app_configs import MAX_PRUNING_DOCUMENT_RETRIEVAL_PER_MINUTE
from callosum.configs.app_configs import VESPA_REQUEST_TIMEOUT
from callosum.connectors.connector_runner import batched_doc_ids
...
def make_probe_path(probe: str, hostname: str) -> Path:
    ...
    e.g. /tmp/callosum_k8s_indexing_readiness.txt
    """
    ...
    return Path(f"/tmp/callosum_k8s_{safe_name}_{probe}.txt")
