...
from callosum.background.celery.tasks.shared.tasks import CallosumCeleryTaskCompletionStatus
from callosum.background.celery.tasks.vespa.document_sync import DOCUMENT_SYNC_FENCE_KEY
from callosum.background.celery.tasks.vespa.document_sync import get_document_sync_payload
from callosum.background.celery.tasks.vespa.document_sync import get_document_sync_remaining
from callosum.background.celery.tasks.vespa.document_sync import reset_document_sync
from callosum.background.celery.tasks.vespa.document_sync import (
...
def vespa_metadata_sync_task(self: Task, document_id: str, *, tenant_id: str) -> bool:
    ...
    completion_status = CallosumCeleryTaskCompletionStatus.UNDEFINED
    ...
    try:
        with get_session_with_current_tenant() as db_session:
            ...
            if not doc:
                ...
                completion_status = CallosumCeleryTaskCompletionStatus.SKIPPED
            else:
                # document set sync
                ...
                completion_status = CallosumCeleryTaskCompletionStatus.SUCCEEDED
    except SoftTimeLimitExceeded:
        task_logger.info(f"SoftTimeLimitExceeded exception. doc={document_id}")
        completion_status = CallosumCeleryTaskCompletionStatus.SOFT_TIME_LIMIT
        ...
        while True:
            ...
            if isinstance(e, httpx.HTTPStatusError):
                ...
                completion_status = (
                    CallosumCeleryTaskCompletionStatus.NON_RETRYABLE_EXCEPTION
                )
                break
            ...
            completion_status = CallosumCeleryTaskCompletionStatus.RETRYABLE_EXCEPTION
            if (
    ...
    return completion_status == CallosumCeleryTaskCompletionStatus.SUCCEEDED
