...
from callosum.db.document import (
...
from callosum.db.index_attempt import get_recent_attempts_for_cc_pair
...
from callosum.db.search_settings import get_all_search_settings
...
from callosum.redis.redis_connector_delete import RedisConnectorDeletePayload
...
@shared_task(
    name=CallosumCeleryTask.CHECK_FOR_CONNECTOR_DELETION,
    ignore_result=True,
...
def check_for_connector_deletion_task(self: Task, *, tenant_id: str) -> bool | None:
    ...
    lock_beat: RedisLock = r.lock(
        CallosumRedisLocks.CHECK_CONNECTOR_DELETION_BEAT_LOCK,
    ...
    try:
        ...
        lock_beat.reacquire()
        if not r.exists(CallosumRedisSignals.BLOCK_VALIDATE_CONNECTOR_DELETION_FENCES):
            ...
            r.set(CallosumRedisSignals.BLOCK_VALIDATE_CONNECTOR_DELETION_FENCES, 1, ex=300)
