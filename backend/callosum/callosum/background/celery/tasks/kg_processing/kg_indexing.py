...
from callosum.background.celery.apps.client import celery_app
from callosum.background.celery.tasks.kg_processing.utils import is_kg_processing_blocked
...
def try_creating_kg_source_reset_task(
    ...
    try:
        ...
        result = celery_app.send_task(
            CallosumCeleryTask.KG_RESET_SOURCE_INDEX,
            kwargs=dict(
                tenant_id=tenant_id,
