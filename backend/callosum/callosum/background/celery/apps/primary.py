...
from callosum.configs.app_configs import CELERY_WORKER_PRIMARY_POOL_OVERFLOW
...
def on_worker_init(sender: Worker, **kwargs: Any) -> None:
    ...
    r.delete(CallosumRedisConstants.ACTIVE_FENCES)
...
celery_app.autodiscover_tasks(
    [
        ...
        "callosum.background.celery.tasks.docprocessing",
        "callosum.background.celery.tasks.evals",
        ...
        "callosum.background.celery.tasks.kg_processing",
        "callosum.background.celery.tasks.user_file_processing",
    ]
)
