...
from callosum.configs.constants import POSTGRES_CELERY_WORKER_DOCFETCHING_APP_NAME
...
celery_app.config_from_object("callosum.background.celery.configs.docfetching")
