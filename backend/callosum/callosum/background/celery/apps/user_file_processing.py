...
from callosum.configs.constants import POSTGRES_CELERY_WORKER_USER_FILE_PROCESSING_APP_NAME
...
celery_app.config_from_object("callosum.background.celery.configs.user_file_processing")
