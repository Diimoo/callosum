...
from callosum.configs.app_configs import CELERY_BROKER_POOL_LIMIT
from callosum.configs.app_configs import CELERY_RESULT_EXPIRES
from callosum.configs.app_configs import REDIS_DB_NUMBER_CELERY
from callosum.configs.app_configs import REDIS_DB_NUMBER_CELERY_RESULT_BACKEND
from callosum.configs.app_configs import REDIS_HEALTH_CHECK_INTERVAL
...
from callosum.configs.app_configs import REDIS_SSL_CA_CERTS
from callosum.configs.app_configs import REDIS_SSL_CERT_REQS
from callosum.configs.app_configs import USE_REDIS_IAM_AUTH
from callosum.configs.constants import CallosumCeleryPriority
from callosum.configs.constants import REDIS_SOCKET_KEEPALIVE_OPTIONS
...
broker_transport_options = {
    "priority_steps": list(range(len(CallosumCeleryPriority))),
...
task_default_priority = CallosumCeleryPriority.MEDIUM
task_acks_late = True
