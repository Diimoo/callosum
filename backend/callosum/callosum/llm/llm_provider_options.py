...
from callosum.llm.constants import PROVIDER_DISPLAY_NAMES
from callosum.llm.utils import model_supports_image_input
from callosum.server.manage.llm.models import ModelConfigurationView
        ...
        WellKnownLLMProviderDescriptor(
            ...
            custom_config_keys=[
                ...
                CustomConfigKey(
                    ...
                    description="Choose how Callosum should authenticate with Bedrock.",
                    is_required=False,
                    key_type=CustomConfigKeyType.SELECT,
        ...
        WellKnownLLMProviderDescriptor(
            ...
            custom_config_keys=[
                ...
                CustomConfigKey(
                    ...
                    "[Vertex AI configuration docs](https://docs.callosum.app/admins/ai_models/google_ai) for all possible values.",
                    is_required=False,
                    is_secret=False,
...
# Display names for Callosum-supported LLM providers (used in admin UI provider selection).
# These override PROVIDER_DISPLAY_NAMES for Callosum-specific branding.
_CALLOSUM_PROVIDER_DISPLAY_NAMES: dict[str, str] = {
...
def get_provider_display_name(provider_name: str) -> str:
    """Get human-friendly display name for an Callosum-supported provider.

    First checks Callosum-specific display names, then falls back to
    PROVIDER_DISPLAY_NAMES from constants.
    """
    if provider_name in _CALLOSUM_PROVIDER_DISPLAY_NAMES:
        return _CALLOSUM_PROVIDER_DISPLAY_NAMES[provider_name]
