...
def from_litellm_model_response_stream(
    ...
    """
    Convert a LiteLLM ModelResponseStream into the simplified Callosum representation.
    """
...
def from_litellm_model_response(
    ...
    """
    Convert a LiteLLM ModelResponse into the simplified Callosum representation.
    """
    response_data = response.model_dump()
    response_id, created, choice_data = _validate_and_extract_base_fields(
