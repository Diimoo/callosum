...
from callosum.configs.app_configs import AWS_REGION_NAME
from callosum.configs.app_configs import S3_AWS_ACCESS_KEY_ID
from callosum.configs.app_configs import S3_AWS_SECRET_ACCESS_KEY
from callosum.configs.app_configs import S3_ENDPOINT_URL
from callosum.configs.app_configs import S3_FILE_STORE_BUCKET_NAME
from callosum.configs.app_configs import S3_FILE_STORE_PREFIX
from callosum.configs.app_configs import S3_GENERATE_LOCAL_CHECKSUM
from callosum.configs.app_configs import S3_VERIFY_SSL
...
from callosum.db.engine.sql_engine import get_session_with_current_tenant_if_none
from callosum.db.file_record import delete_filerecord_by_file_id
from callosum.db.file_record import get_filerecord_by_file_id
from callosum.db.file_record import get_filerecord_by_file_id_optional
from callosum.db.file_record import get_filerecord_by_prefix
from callosum.db.file_record import upsert_filerecord
from callosum.db.models import FileRecord
from callosum.db.models import FileRecord as FileStoreModel
from callosum.file_store.s3_key_utils import generate_s3_key
...
class S3BackedFileStore(FileStore):
    ...
    def __init__(
        ...
        self._s3_prefix = s3_prefix or "callosum-files"
...
def get_default_file_store() -> FileStore:
    ...
    - S3_FILE_STORE_PREFIX=<prefix> (optional, defaults to 'callosum-files')
