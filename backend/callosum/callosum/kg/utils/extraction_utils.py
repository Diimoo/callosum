...
from callosum.configs.constants import CallosumCallTypes
from callosum.configs.kg_configs import KG_METADATA_TRACKING_THRESHOLD
from callosum.db.engine.sql_engine import get_session_with_current_tenant
from callosum.db.entities import get_kg_entity_by_document
from callosum.db.entity_type import get_entity_types
from callosum.db.kg_config import KGConfigSettings
from callosum.db.models import Document
from callosum.db.models import KGEntityType
from callosum.db.models import KGRelationshipType
from callosum.db.tag import get_structured_tags_for_document
...
from callosum.kg.models import KGChunkFormat
from callosum.kg.models import KGClassificationInstructions
from callosum.kg.models import KGClassificationResult
...
from callosum.kg.models import KGMetadataContent
from callosum.kg.utils.formatting_utils import extract_email
from callosum.kg.utils.formatting_utils import get_entity_type
from callosum.kg.utils.formatting_utils import kg_email_processing
from callosum.kg.utils.formatting_utils import make_entity_id
from callosum.kg.utils.formatting_utils import make_relationship_id
from callosum.kg.utils.formatting_utils import make_relationship_type_id
from callosum.kg.vespa.vespa_interactions import get_document_vespa_contents
from callosum.llm.factory import get_default_llm
from callosum.llm.utils import llm_response_to_string
from callosum.prompts.kg_prompts import CALL_CHUNK_PREPROCESSING_PROMPT
from callosum.prompts.kg_prompts import CALL_DOCUMENT_CLASSIFICATION_PROMPT
from callosum.prompts.kg_prompts import GENERAL_CHUNK_PREPROCESSING_PROMPT
from callosum.prompts.kg_prompts import MASTER_EXTRACTION_PROMPT
...
def kg_implied_extraction(
    ...
    document_is_from_call = document_entity_type.lower() in (
        call_type.value.lower() for call_type in CallosumCallTypes
    )
...
def kg_classify_document(
    ...
    if entity_type not in (call_type.value for call_type in CallosumCallTypes):
        return None
...
def kg_deep_extract_chunks(
    ...
    entity_type = get_entity_type(document_entity)
    is_call = entity_type in (call_type.value for call_type in CallosumCallTypes)
