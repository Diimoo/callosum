...
from callosum.configs.app_configs import NOTION_CONNECTOR_DISABLE_RECURSIVE_PAGE_LOOKUP
        ...
        try:
            ...
            if res.status_code == 404:
                ...
                logger.error(
                    ...
                    f"with the Callosum integration. Exact exception:\n\n{e}"
                )
            else:
                logger.exception(
            ...
            for result in data["results"]:
                ...
                if result_type == "ai_block":
                    logger.warning(
                        ...
                        f"(discussion: https://github.com/callosum-dot-app/callosum/issues/1053)"
                    )
                    continue
                ...
                if result_type == "unsupported":
                    logger.warning(
                        ...
                        f"(discussion: https://github.com/callosum-dot-app/callosum/issues/1230)"
                    )
                    continue
                ...
                if result_type == "external_object_instance_page":
                    logger.warning(
                        ...
                        f"(discussion: https://github.com/callosum-dot-app/callosum/issues/1761)"
                    )
                    continue
