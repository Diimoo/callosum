...
from callosum.configs.app_configs import GOOGLE_DRIVE_CONNECTOR_SIZE_THRESHOLD
from callosum.configs.app_configs import INDEX_BATCH_SIZE
from callosum.configs.app_configs import MAX_DRIVE_WORKERS
...
from callosum.connectors.exceptions import InsufficientPermissionsError
from callosum.connectors.google_drive.doc_conversion import build_slim_document
from callosum.connectors.google_drive.doc_conversion import (
    convert_drive_item_to_document,
)
from callosum.connectors.google_drive.doc_conversion import callosum_document_id_from_drive_file
from callosum.connectors.google_drive.doc_conversion import PermissionSyncContext
from callosum.connectors.google_drive.file_retrieval import crawl_folders_for_files
from callosum.connectors.google_drive.file_retrieval import DriveFileFieldType
from callosum.connectors.google_drive.file_retrieval import get_all_files_for_oauth
from callosum.connectors.google_drive.file_retrieval import (
    get_all_files_in_my_drive_and_shared,
)
from callosum.connectors.google_drive.file_retrieval import get_files_in_shared_drive
from callosum.connectors.google_drive.file_retrieval import get_root_folder_id
...
from callosum.connectors.google_drive.models import GoogleDriveCheckpoint
from callosum.connectors.google_drive.models import GoogleDriveFileType
from callosum.connectors.google_drive.models import RetrievedDriveFile
from callosum.connectors.google_drive.models import StageCompletion
from callosum.connectors.google_utils.google_auth import get_google_creds
from callosum.connectors.google_utils.google_utils import execute_paginated_retrieval
from callosum.connectors.google_utils.google_utils import get_file_owners
from callosum.connectors.google_utils.google_utils import GoogleFields
from callosum.connectors.google_utils.resources import get_admin_service
from callosum.connectors.google_utils.resources import get_drive_service
from callosum.connectors.google_utils.resources import GoogleDriveService
from callosum.connectors.google_utils.shared_constants import (
    DB_CREDENTIALS_PRIMARY_ADMIN_KEY,
)
from callosum.connectors.google_utils.shared_constants import MISSING_SCOPES_ERROR_STR
from callosum.connectors.google_utils.shared_constants import CALLOSUM_SCOPE_INSTRUCTIONS
from callosum.connectors.google_utils.shared_constants import SLIM_BATCH_SIZE
from callosum.connectors.google_utils.shared_constants import USER_FIELDS
...
from callosum.connectors.interfaces import GenerateSlimDocumentOutput
from callosum.connectors.interfaces import SecondsSinceUnixEpoch
from callosum.connectors.interfaces import SlimConnectorWithPermSync
...
from callosum.connectors.models import EntityFailure
...
from callosum.utils.retry_wrapper import retry_builder
from callosum.utils.threadpool_concurrency import parallel_yield
from callosum.utils.threadpool_concurrency import run_functions_tuples_in_parallel
from callosum.utils.threadpool_concurrency import ThreadSafeDict
...
class GoogleDriveConnector(
    ...
    def _checkpointed_retrieval(
        ...
        for file in drive_files:
            ...
            try:
                document_id = callosum_document_id_from_drive_file(drive_file)
    ...
    def _load_from_checkpoint(
        ...
        try:
            ...
            if MISSING_SCOPES_ERROR_STR in str(e):
                raise PermissionError(CALLOSUM_SCOPE_INSTRUCTIONS) from e
            raise e
