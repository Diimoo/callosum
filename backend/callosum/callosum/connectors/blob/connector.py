...
from callosum.configs.app_configs import BLOB_STORAGE_SIZE_THRESHOLD
            ...
            if authentication_method == "access_key":
                ...
                def _refresh_credentials() -> dict[str, str]:
                    ...
                    assumed_role_object = sts_client.assume_role(
                        RoleArn=role_arn,
                        RoleSessionName=f"callosum_blob_storage_{int(time.time())}",
                    )
    ...
    def _yield_blob_objects(
        ...
        for page in pages:
            ...
            for obj in page["Contents"]:
                ...
                # Handle image files
                if file_ext in CallosumFileExtensions.IMAGE_EXTENSIONS:
                ...
                try:
                    ...
                    callosum_metadata, custom_tags = process_callosum_metadata(
                        extraction_result.metadata
                    )
                    file_display_name = callosum_metadata.file_display_name or file_name
                    time_updated = callosum_metadata.doc_updated_at or last_modified
                    ...
                    source_type = callosum_metadata.source_type or DocumentSource(
