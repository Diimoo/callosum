...
from callosum.utils.text_processing import make_url_compatible
...
class DocumentBase(BaseModel):
    """Used for Callosum ingestion api, the ID is inferred before use if not provided"""
...
class Document(DocumentBase):
    """Used for Callosum ingestion api, the ID is required"""
...
class CallosumMetadata(BaseModel):
