...
SCOPE_DOC_URL = "https://docs.callosum.app/admins/connectors/official/google_drive/overview"
CALLOSUM_SCOPE_INSTRUCTIONS = (
    "You have upgraded Callosum without updating the Google Auth scopes. "
