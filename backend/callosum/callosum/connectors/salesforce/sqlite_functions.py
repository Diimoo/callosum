...
from callosum.connectors.salesforce.utils import SalesforceObject
from callosum.connectors.salesforce.utils import USER_OBJECT_TYPE
from callosum.connectors.salesforce.utils import validate_salesforce_id
...
class CallosumSalesforceSQLite:
    ...
    def apply_schema(self) -> None:
        ...
        with self._conn:
            ...
            if cursor.fetchone()[0] == 0:
                CallosumSalesforceSQLite._update_user_email_map(cursor)
            elapsed = time.monotonic() - start
            ...
            with open(csv_download_path, "r", newline="", encoding="utf-8") as f:
                ...
                for row in reader:
                    ...
                    normalized_record, parent_ids = (
                        CallosumSalesforceSQLite.normalize_record(row, remove_ids)
                    )
                    ...
                    CallosumSalesforceSQLite._update_relationship_tables(
