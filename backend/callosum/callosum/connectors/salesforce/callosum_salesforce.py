...
from callosum.connectors.cross_connector_utils.rate_limit_wrapper import (
    rate_limit_builder,
)
from callosum.connectors.salesforce.blacklist import SALESFORCE_BLACKLISTED_OBJECTS
from callosum.connectors.salesforce.blacklist import SALESFORCE_BLACKLISTED_PREFIXES
from callosum.connectors.salesforce.blacklist import SALESFORCE_BLACKLISTED_SUFFIXES
...
class CallosumSalesforce(Salesforce):
    ...
    def get_child_objects_by_id(
        ...
        while True:
            ...
            if len(child_relationships_batch) >= CallosumSalesforce.SOQL_MAX_SUBQUERIES:
                process_batch = True
            ...
            if process_batch:
                ...
                query = CallosumSalesforce._make_child_objects_by_id_query(
                    object_id,
                    sf_type,
