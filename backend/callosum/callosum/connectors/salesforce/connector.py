...
from callosum.connectors.salesforce.doc_conversion import convert_sf_object_to_doc
from callosum.connectors.salesforce.doc_conversion import convert_sf_query_result_to_doc
...
from callosum.connectors.salesforce.salesforce_calls import fetch_all_csvs_in_parallel
...
from callosum.connectors.salesforce.utils import BASE_DATA_PATH
from callosum.connectors.salesforce.utils import get_sqlite_db_path
from callosum.connectors.salesforce.utils import ID_FIELD
from callosum.connectors.salesforce.utils import MODIFIED_FIELD
from callosum.connectors.salesforce.utils import NAME_FIELD
...
class SalesforceConnector(LoadConnector, PollConnector, SlimConnectorWithPermSync):
    ...
    def __init__(
        ...
        self._sf_client: CallosumSalesforce | None = None
    ...
    def load_credentials(
        ...
        self._sf_client = CallosumSalesforce(
    ...
    @property
    def sf_client(self) -> CallosumSalesforce:
    ...
    def _load_csvs_to_db(
        csv_directory: str, remove_ids: bool, sf_db: CallosumSalesforceSQLite
    ) -> dict[str, str]:
        """
        ...
        # from import callosum.connectors.salesforce.sf_db.sqlite_functions find_ids_by_type
    ...
    #     parent_types: list[str], sf_client: CallosumSalesforce
    # ) -> set[str]:
    ...
    def _full_sync(
        ...
        sf_db = CallosumSalesforceSQLite(os.path.join(temp_dir, "salesforce_db.sqlite"))
        sf_db.connect()
    ...
    def _make_context(
        ...
        for parent_type in parent_types:
            # parent_callosum_sf_type = CallosumSalesforceType(parent_type, sf_client)
        ...
        for sf_type in all_types:
            # callosum_sf_type = CallosumSalesforceType(sf_type, sf_client)
