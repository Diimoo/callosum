...
CALLOSUM_SLACK_LOCK_TTL = 1800  # how long the lock is allowed to idle before it expires
CALLOSUM_SLACK_LOCK_BLOCKING_TIMEOUT = 60  # how long to wait for the lock per wait attempt
CALLOSUM_SLACK_LOCK_TOTAL_BLOCKING_TIMEOUT = 3600  # how long to wait for the lock in total
