...
class CallosumDBCredentialsProvider(
    CredentialsProviderInterface["CallosumDBCredentialsProvider"]
):
    ...
    def __enter__(self) -> "CallosumDBCredentialsProvider":
...
class CallosumStaticCredentialsProvider(
    CredentialsProviderInterface["CallosumStaticCredentialsProvider"]
):
    ...
    def __enter__(self) -> "CallosumStaticCredentialsProvider":
        return self
