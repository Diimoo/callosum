...
from callosum.configs.app_configs import CONFLUENCE_CONNECTOR_LABELS_TO_SKIP
from callosum.configs.app_configs import CONFLUENCE_TIMEZONE_OFFSET
from callosum.configs.app_configs import CONTINUE_ON_CONNECTOR_FAILURE
from callosum.configs.app_configs import INDEX_BATCH_SIZE
from callosum.configs.constants import DocumentSource
from callosum.connectors.confluence.access import get_all_space_permissions
from callosum.connectors.confluence.access import get_page_restrictions
from callosum.connectors.confluence.callosum_confluence import extract_text_from_confluence_html
from callosum.connectors.confluence.callosum_confluence import CallosumConfluence
from callosum.connectors.confluence.utils import build_confluence_document_id
from callosum.connectors.confluence.utils import convert_attachment_to_content
from callosum.connectors.confluence.utils import datetime_from_string
from callosum.connectors.confluence.utils import update_param_in_path
from callosum.connectors.confluence.utils import validate_attachment_filetype
...
from callosum.connectors.interfaces import ConnectorCheckpoint
from callosum.connectors.interfaces import ConnectorFailure
from callosum.connectors.interfaces import CredentialsConnector
from callosum.connectors.interfaces import CredentialsProviderInterface
...
from callosum.connectors.interfaces import SlimConnector
...
from callosum.connectors.models import SlimDocument
...
class ConfluenceConnector(
    ...
    def __init__(
        ...
        self._confluence_client: CallosumConfluence | None = None
        self._low_timeout_confluence_client: CallosumConfluence | None = None
    ...
    @property
    def confluence_client(self) -> CallosumConfluence:
        if self._confluence_client is None:
            raise ConnectorMissingCredentialError("Confluence")
        return self._confluence_client

    @property
    def low_timeout_confluence_client(self) -> CallosumConfluence:
    ...
    def set_credentials_provider(
        ...
        low_timeout_confluence_client = CallosumConfluence(
            is_cloud=self.is_cloud,
            url=self.wiki_base,
            credentials_provider=credentials_provider,
            timeout=3,
