...
from callosum.configs.app_configs import CONFLUENCE_CONNECTOR_USER_PROFILES_OVERRIDE
from callosum.configs.app_configs import OAUTH_CONFLUENCE_CLOUD_CLIENT_ID
from callosum.configs.app_configs import OAUTH_CONFLUENCE_CLOUD_CLIENT_SECRET
from callosum.connectors.confluence.models import ConfluenceUser
from callosum.connectors.confluence.user_profile_override import (
    process_confluence_user_profiles_override,
)
from callosum.connectors.confluence.utils import _handle_http_error
from callosum.connectors.confluence.utils import confluence_refresh_tokens
from callosum.connectors.confluence.utils import get_start_param_from_url
from callosum.connectors.confluence.utils import update_param_in_path
from callosum.connectors.cross_connector_utils.miscellaneous_utils import scoped_url
from callosum.connectors.interfaces import CredentialsProviderInterface
from callosum.file_processing.html_utils import format_document_soup
    ...
    def _initialize_connection_helper(
        ...
        **kwargs: Any,
        ...
        if "confluence_refresh_token" in credentials:
            ...
            oauth2_dict: dict[str, Any] = CallosumConfluence._make_oauth2_dict(credentials)
...
def get_user_email_from_username__server(
    confluence_client: CallosumConfluence, user_name: str
) -> str | None:
...
def _get_user(confluence_client: CallosumConfluence, user_id: str) -> str:
