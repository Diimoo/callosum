...
from callosum.configs.app_configs import CONNECTOR_LOCALHOST_OVERRIDE
...
from callosum.connectors.models import CallosumMetadata
from callosum.utils.logger import setup_logger
from callosum.utils.text_processing import is_valid_email
...
def process_callosum_metadata(
    metadata: dict[str, Any],
) -> tuple[CallosumMetadata, dict[str, Any]]:
    """
    Users may set Callosum metadata and custom tags in text files. https://docs.callosum.app/admins/connectors/official/file
