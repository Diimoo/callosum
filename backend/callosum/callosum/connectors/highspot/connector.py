...
from callosum.connectors.highspot.client import HighspotClient
from callosum.connectors.highspot.client import HighspotClientError
from callosum.connectors.highspot.utils import scrape_url_content
    ...
    def _get_item_content(self, item_details: Dict[str, Any]) -> str:
        ...
        try:
            if content_type == "WebLink":
                ...
                is_valid_format
                and file_extension in CallosumFileExtensions.TEXT_AND_DOCUMENT_EXTENSIONS
                and can_download
            ):
