...
from callosum.configs.app_configs import REQUEST_TIMEOUT_SECONDS
from callosum.configs.app_configs import SHAREPOINT_CONNECTOR_SIZE_THRESHOLD
...
from callosum.connectors.interfaces import IndexingHeartbeatInterface
...
from callosum.connectors.models import ExternalAccess
...
from callosum.connectors.sharepoint.connector_utils import get_sharepoint_external_access
...
def _convert_driveitem_to_document_with_permissions(
    ...
    try:
        ...
        if not mime_type or mime_type in CallosumMimeTypes.EXCLUDED_IMAGE_TYPES:
    ...
    if not content_bytes:
    ...
    elif file_ext in CallosumFileExtensions.IMAGE_EXTENSIONS:
        ...
        # Note: we don't process Callosum metadata for connectors like Drive & Sharepoint, but could
        def _store_embedded_image(img_data: bytes, img_name: str) -> None:
            ...
            if mime_type in CallosumMimeTypes.EXCLUDED_IMAGE_TYPES:
                logger.debug(
    ...
    def _load_from_checkpoint(
        ...
        if (
            ...
            for driveitem in driveitems:
                ...
                if driveitem_extension not in CallosumFileExtensions.ALL_ALLOWED_EXTENSIONS:
                    logger.warning(
                ...
                should_yield_if_empty = (
                    driveitem_extension in CallosumFileExtensions.IMAGE_EXTENSIONS
