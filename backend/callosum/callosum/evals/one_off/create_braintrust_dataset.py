...
def create_braintrust_dataset(records: List[Dict[str, Any]], dataset_name: str) -> None:
    ...
    dataset = init_dataset("Callosum", dataset_name, api_key=BRAINTRUST_API_KEY)
...
def main() -> None:
    ...
    parser.add_argument(
        "--csv-path",
        default="/Users/richardguan/callosum/backend/callosum/evals/data/DR Master Question & Metric Sheet - Sheet1.csv",
