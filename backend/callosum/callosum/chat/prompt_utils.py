...
from callosum.db.persona import get_default_behavior_persona
from callosum.db.user_file import calculate_user_files_token_count
from callosum.file_store.models import FileDescriptor
from callosum.prompts.chat_prompts import CITATION_REMINDER
from callosum.prompts.chat_prompts import CODE_BLOCK_MARKDOWN
from callosum.prompts.chat_prompts import DEFAULT_SYSTEM_PROMPT
from callosum.prompts.chat_prompts import REQUIRE_CITATION_GUIDANCE
from callosum.prompts.chat_prompts import USER_INFO_HEADER
from callosum.prompts.prompt_utils import get_company_context
from callosum.prompts.prompt_utils import handle_callosum_date_awareness
from callosum.prompts.prompt_utils import replace_citation_guidance_tag
from callosum.prompts.tool_prompts import GENERATE_IMAGE_GUIDANCE
from callosum.prompts.tool_prompts import INTERNAL_SEARCH_GUIDANCE
from callosum.prompts.tool_prompts import OPEN_URLS_GUIDANCE
from callosum.prompts.tool_prompts import PYTHON_TOOL_GUIDANCE
from callosum.prompts.tool_prompts import TOOL_DESCRIPTION_SEARCH_GUIDANCE
from callosum.prompts.tool_prompts import TOOL_SECTION_HEADER
from callosum.prompts.tool_prompts import WEB_SEARCH_GUIDANCE
...
def build_system_prompt(
    ...
    """
    system_prompt = handle_callosum_date_awareness(base_system_prompt, datetime_aware)
