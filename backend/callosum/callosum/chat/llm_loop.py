...
from callosum.chat.prompt_utils import build_reminder_message
from callosum.chat.prompt_utils import build_system_prompt
from callosum.chat.prompt_utils import (
...
from callosum.llm.interfaces import ToolChoiceOptions
from callosum.llm.utils import model_needs_formatting_reenabled
from callosum.prompts.chat_prompts import IMAGE_GEN_REMINDER
from callosum.prompts.chat_prompts import OPEN_URL_REMINDER
...
from callosum.tools.built_in_tools import CITEABLE_TOOLS_NAMES
from callosum.tools.built_in_tools import STOPPING_TOOLS_NAMES
...
from callosum.tools.tool_implementations.images.models import (
...
def run_llm_loop(
    ...
    with trace(
        ...
        from callosum.llm.litellm_singleton.config import (
            initialize_litellm,
