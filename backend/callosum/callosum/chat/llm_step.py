...
from callosum.configs.app_configs import LOG_CALLOSUM_MODEL_INTERACTIONS
...
from callosum.llm.interfaces import LanguageModelInput
...
from callosum.llm.model_response import Delta
from callosum.llm.models import AssistantMessage
from callosum.llm.models import ChatCompletionMessage
from callosum.llm.models import FunctionCall
from callosum.llm.models import ImageContentPart
from callosum.llm.models import ImageUrlDetail
from callosum.llm.models import ReasoningEffort
from callosum.llm.models import SystemMessage
from callosum.llm.models import TextContentPart
from callosum.llm.models import ToolCall
from callosum.llm.models import ToolMessage
from callosum.llm.models import UserMessage
...
from callosum.server.query_and_chat.streaming_models import ReasoningDone
from callosum.server.query_and_chat.streaming_models import ReasoningStart
from callosum.tools.models import TOOL_CALL_MSG_ARGUMENTS
from callosum.tools.models import TOOL_CALL_MSG_FUNC_NAME
from callosum.tools.models import ToolCallKickoff
from callosum.tracing.framework.create import generation_span
from callosum.utils.b64 import get_image_type_from_bytes
...
def run_llm_step_pkt_generator(
    ...
    if LOG_CALLOSUM_MODEL_INTERACTIONS:
        logger.info(
