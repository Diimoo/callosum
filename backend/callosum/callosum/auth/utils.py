...
from callosum.auth.constants import API_KEY_HEADER_ALTERNATIVE_NAME
from callosum.auth.constants import API_KEY_HEADER_NAME
from callosum.auth.constants import API_KEY_PREFIX
from callosum.auth.constants import BEARER_PREFIX
from callosum.auth.constants import DEPRECATED_API_KEY_PREFIX
from callosum.auth.constants import PAT_PREFIX
...
def get_hashed_bearer_token_from_request(
    ...
    Args:
        ...
        valid_prefixes: List of valid token prefixes (e.g., ["on_", "callosum_pat_"])
