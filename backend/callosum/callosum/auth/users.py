...
from callosum.auth.api_key import get_hashed_api_key_from_request
from callosum.auth.email_utils import send_forgot_password_email
from callosum.auth.email_utils import send_user_verification_email
...
from callosum.auth.jwt import verify_jwt_token
from callosum.auth.pat import get_hashed_pat_from_request
from callosum.auth.schemas import AuthBackend
from callosum.auth.schemas import UserCreate
from callosum.auth.schemas import UserRole
from callosum.auth.schemas import UserUpdateWithRole
from callosum.configs.app_configs import AUTH_BACKEND
from callosum.configs.app_configs import AUTH_COOKIE_EXPIRE_TIME_SECONDS
from callosum.configs.app_configs import AUTH_TYPE
from callosum.configs.app_configs import DISABLE_AUTH
from callosum.configs.app_configs import EMAIL_CONFIGURED
from callosum.configs.app_configs import JWT_PUBLIC_KEY_URL
from callosum.configs.app_configs import PASSWORD_MAX_LENGTH
from callosum.configs.app_configs import PASSWORD_MIN_LENGTH
from callosum.configs.app_configs import PASSWORD_REQUIRE_DIGIT
from callosum.configs.app_configs import PASSWORD_REQUIRE_LOWERCASE
from callosum.configs.app_configs import PASSWORD_REQUIRE_SPECIAL_CHAR
from callosum.configs.app_configs import PASSWORD_REQUIRE_UPPERCASE
from callosum.configs.app_configs import REDIS_AUTH_KEY_PREFIX
from callosum.configs.app_configs import REQUIRE_EMAIL_VERIFICATION
from callosum.configs.app_configs import SESSION_EXPIRE_TIME_SECONDS
from callosum.configs.app_configs import TRACK_EXTERNAL_IDP_EXPIRY
...
from callosum.configs.constants import ANONYMOUS_USER_COOKIE_NAME
from callosum.configs.constants import AuthType
from callosum.configs.constants import DANSWER_API_KEY_DUMMY_EMAIL_DOMAIN
from callosum.configs.constants import DANSWER_API_KEY_PREFIX
...
from callosum.configs.constants import PASSWORD_SPECIAL_CHARS
from callosum.configs.constants import UNNAMED_KEY_PLACEHOLDER
from callosum.db.api_key import fetch_user_for_api_key
from callosum.db.auth import get_access_token_db
from callosum.db.auth import get_default_admin_user_emails
from callosum.db.auth import get_user_count
from callosum.db.auth import get_user_db
from callosum.db.auth import SQLAlchemyUserAdminDB
from callosum.db.engine.async_sql_engine import get_async_session
from callosum.db.engine.async_sql_engine import get_async_session_context_manager
from callosum.db.engine.sql_engine import get_session_with_tenant
from callosum.db.models import AccessToken
from callosum.db.models import OAuthAccount
from callosum.db.models import Persona
from callosum.db.models import User
from callosum.db.pat import fetch_user_for_pat
from callosum.db.users import get_user_by_email
from callosum.redis.redis_pool import get_async_redis_connection
...
from callosum.utils.url import add_url_params
...
def anonymous_user_enabled(*, tenant_id: str | None = None) -> bool:
    ...
    value = redis_client.get(CallosumRedisLocks.ANONYMOUS_USER_ENABLED)
...
class UserManager(UUIDIDMixin, BaseUserManager[User, uuid.UUID]):
    ...
    async def create(
        ...
        tenant_id = await fetch_ee_implementation_or_noop(
            "callosum.server.tenants.provisioning",
    ...
    async def on_after_register(
        ...
        get_marketing_posthog_cookie_name = fetch_ee_implementation_or_noop(
            module="callosum.utils.posthog_client",
        ...
        if (
            ...
            properties = {
                "email": user.email,
                "callosum_cloud_user_id": str(user.id),
...
class FastAPIUserWithLogoutRouter(FastAPIUsers[models.UP, models.ID]):
    ...
    def get_refresh_router(
        ...
        from callosum.auth.oauth_refresher import check_and_refresh_oauth_tokens
...
def get_default_admin_user_emails_() -> list[str]:
    # No default seeding available for Callosum MIT
    return []
...
def create_callosum_oauth_router(
