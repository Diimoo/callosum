...
from callosum.configs.app_configs import EMAIL_FROM
from callosum.configs.app_configs import SENDGRID_API_KEY
from callosum.configs.app_configs import SMTP_PASS
from callosum.configs.app_configs import SMTP_PORT
from callosum.configs.app_configs import SMTP_SERVER
from callosum.configs.app_configs import SMTP_USER
...
from callosum.configs.constants import CALLOSUM_DISCORD_URL
...
def build_html_email(
    ...
    community_link_fragment = ""
    if application_name == CALLOSUM_DEFAULT_APPLICATION_NAME:
        community_link_fragment = f'<br>Have questions? Join our Discord community <a href="{CALLOSUM_DISCORD_URL}">here</a>.'
...
def send_email_with_sendgrid(
    ...
    from_email = Email(mail_from) if mail_from else Email("noreply@callosum.app")
...
def send_email_with_smtplib(
    ...
    msg["Message-ID"] = make_msgid(domain="callosum.app")
...
def send_subscription_cancellation_email(user_email: str) -> None:
    ...
    try:
        load_runtime_settings_fn = fetch_versioned_implementation(
            "callosum.server.enterprise_settings.store", "load_runtime_settings"
        )
    ...
    cta_link = "https://www.callosum.app/pricing"
    ...
    text_content = (
        ...
        "If you change your mind, visit https://www.callosum.app/pricing"
    )
    send_email(
        user_email,
        subject,
