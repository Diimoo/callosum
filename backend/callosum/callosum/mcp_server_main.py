...
from callosum.configs.app_configs import MCP_SERVER_ENABLED
from callosum.configs.app_configs import MCP_SERVER_PORT
...
def main() -> None:
    ...
    from callosum.mcp_server.api import mcp_app
