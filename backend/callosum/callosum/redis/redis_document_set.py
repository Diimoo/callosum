...
from callosum.db.document_set import construct_document_id_select_by_docset
from callosum.redis.redis_object_helper import RedisObjectHelper
    ...
    def generate_tasks(
        ...
        for doc_id in db_session.scalars(stmt).yield_per(DB_YIELD_PER_DEFAULT):
            ...
            celery_app.send_task(
                CallosumCeleryTask.VESPA_METADATA_SYNC_TASK,
                kwargs=dict(document_id=doc_id, tenant_id=tenant_id),
                queue=CallosumCeleryQueues.VESPA_METADATA_SYNC,
