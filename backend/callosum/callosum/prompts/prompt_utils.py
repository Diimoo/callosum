...
from callosum.prompts.chat_prompts import COMPANY_DESCRIPTION_BLOCK
from callosum.prompts.chat_prompts import COMPANY_NAME_BLOCK
...
def handle_callosum_date_awareness(
    prompt_str: str,
