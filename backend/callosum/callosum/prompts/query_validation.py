...
from callosum.prompts.constants import QUESTION_PAT
...
{QUESTION_PAT.upper()} Callosum is unreachable.
```
{THOUGHT_PAT.upper()} The system searches documents related to Callosum being unreachable. \
Assuming the documents from search contains situations where Callosum is not reachable and \
