...
from callosum.configs.app_configs import CURATORS_CANNOT_VIEW_OR_EDIT_NON_OWNED_ASSISTANTS
...
from callosum.db.models import Persona__User
from callosum.db.models import Persona__UserGroup
from callosum.db.models import PersonaLabel
from callosum.db.models import StarterMessage
from callosum.db.models import Tool
from callosum.db.models import User
from callosum.db.models import User__UserGroup
...
from callosum.server.features.persona.models import FullPersonaSnapshot
from callosum.server.features.persona.models import MinimalPersonaSnapshot
...
from callosum.server.features.tool.tool_visibility import should_expose_tool_to_fe
...
def make_persona_private(
    ...
    if group_ids:
        raise NotImplementedError("Callosum MIT does not support private Personas")
...
def create_update_persona(
    ...
    try:
        ...
        versioned_make_persona_private = fetch_versioned_implementation(
            "callosum.db.persona", "make_persona_private"
        )
