...
from callosum.db.federated import create_federated_connector_document_set_mapping
...
from callosum.db.models import DocumentSet as DocumentSetDBModel
from callosum.db.models import DocumentSet__ConnectorCredentialPair
from callosum.db.models import DocumentSet__UserGroup
...
def delete_document_set_privacy__no_commit(
    ...
    """No private document sets in Callosum MIT"""
...
def make_doc_set_private(
    ...
    if user_ids or group_ids:
        raise NotImplementedError("Callosum MIT does not support private Document Sets")
...
def insert_document_set(
    ...
    try:
        ...
        versioned_private_doc_set_fn = fetch_versioned_implementation(
            "callosum.db.document_set", "make_doc_set_private"
        )
...
def mark_document_set_as_to_be_deleted(
    ...
    try:
        ...
        versioned_delete_private_fn = fetch_versioned_implementation(
            "callosum.db.document_set", "delete_document_set_privacy__no_commit"
        )
