...
from callosum.configs.app_configs import USER_FILE_INDEXING_LIMIT
...
from callosum.db.credentials import fetch_credential_by_id
...
def add_credential_to_connector(
    ...
    if access_type == AccessType.SYNC:
        if not fetch_ee_implementation_or_noop(
            "callosum.external_permissions.sync_params",
