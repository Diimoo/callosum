...
from callosum.configs.kg_configs import KG_SIMPLE_ANSWER_MAX_DISPLAYED_SOURCES
from callosum.db.chunk import delete_chunk_stats_by_connector_credential_pair__no_commit
...
from callosum.db.entities import delete_from_kg_entities_extraction_staging__no_commit
from callosum.db.enums import AccessType
from callosum.db.enums import ConnectorCredentialPairStatus
from callosum.db.feedback import delete_document_feedback_for_documents__no_commit
...
from callosum.db.relationships import (
    delete_from_kg_relationships_extraction_staging__no_commit,
)
from callosum.db.tag import delete_document_tags_for_documents__no_commit
from callosum.db.utils import DocumentRow
from callosum.db.utils import model_to_dict
...
def get_access_info_for_documents(
    ...
    - List of emails of Callosum users with direct access to the doc (includes a "None" element if
