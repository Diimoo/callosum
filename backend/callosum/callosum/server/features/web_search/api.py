...
from callosum.db.web_search import fetch_active_web_content_provider
from callosum.db.web_search import fetch_active_web_search_provider
from callosum.server.features.web_search.models import OpenUrlsToolRequest
from callosum.server.features.web_search.models import OpenUrlsToolResponse
from callosum.server.features.web_search.models import WebSearchToolRequest
from callosum.server.features.web_search.models import WebSearchToolResponse
from callosum.server.features.web_search.models import WebSearchWithContentResponse
...
from callosum.tools.models import LlmOpenUrlResult
from callosum.tools.models import LlmWebSearchResult
from callosum.tools.tool_implementations.open_url.models import WebContentProvider
from callosum.tools.tool_implementations.open_url.callosum_web_crawler import (
    CallosumWebCrawler,
)
from callosum.tools.tool_implementations.web_search.models import WebContentProviderConfig
from callosum.tools.tool_implementations.web_search.models import WebSearchProvider
...
from callosum.tools.tool_implementations.web_search.utils import (
...
def _get_active_content_provider(
    ...
    if provider_model is None:
        ...
        # NOTE: the CallosumWebCrawler is not stored in the content provider table,
        # so we need to return it directly.

        return None, CallosumWebCrawler()
...
def _open_urls(
    ...
    provider_type = (
        ...
        if provider_view
        else WebContentProviderType.CALLOSUM_WEB_CRAWLER
    )
