...
from callosum.db.enums import MCPAuthenticationPerformer
from callosum.db.enums import MCPAuthenticationType
from callosum.db.enums import MCPServerStatus
from callosum.db.enums import MCPTransport
from callosum.db.mcp import create_connection_config
from callosum.db.mcp import create_mcp_server__no_commit
from callosum.db.mcp import delete_all_user_connection_configs_for_server_no_commit
from callosum.db.mcp import delete_connection_config
from callosum.db.mcp import delete_mcp_server
from callosum.db.mcp import delete_user_connection_configs_for_server
from callosum.db.mcp import get_all_mcp_servers
from callosum.db.mcp import get_connection_config_by_id
from callosum.db.mcp import get_mcp_server_by_id
from callosum.db.mcp import get_mcp_servers_for_persona
from callosum.db.mcp import get_server_auth_template
from callosum.db.mcp import get_user_connection_config
from callosum.db.mcp import update_connection_config
from callosum.db.mcp import update_mcp_server__no_commit
from callosum.db.mcp import upsert_user_connection_config
from callosum.db.models import MCPConnectionConfig
from callosum.db.models import MCPServer as DbMCPServer
from callosum.db.models import Tool
from callosum.db.models import User
from callosum.db.tools import create_tool__no_commit
from callosum.db.tools import delete_tool__no_commit
from callosum.db.tools import get_tools_by_mcp_server_id
from callosum.redis.redis_pool import get_redis_client
from callosum.server.features.mcp.models import MCPApiKeyResponse
from callosum.server.features.mcp.models import MCPAuthTemplate
from callosum.server.features.mcp.models import MCPConnectionData
from callosum.server.features.mcp.models import MCPOAuthCallbackResponse
from callosum.server.features.mcp.models import MCPOAuthKeys
from callosum.server.features.mcp.models import MCPServer
from callosum.server.features.mcp.models import MCPServerCreateResponse
from callosum.server.features.mcp.models import MCPServerSimpleCreateRequest
from callosum.server.features.mcp.models import MCPServerSimpleUpdateRequest
from callosum.server.features.mcp.models import MCPServersResponse
from callosum.server.features.mcp.models import MCPServerUpdateResponse
from callosum.server.features.mcp.models import MCPToolCreateRequest
from callosum.server.features.mcp.models import MCPToolListResponse
from callosum.server.features.mcp.models import MCPToolUpdateRequest
from callosum.server.features.mcp.models import MCPUserCredentialsRequest
from callosum.server.features.mcp.models import MCPUserOAuthConnectRequest
from callosum.server.features.mcp.models import MCPUserOAuthConnectResponse
from callosum.server.features.tool.models import ToolSnapshot
from callosum.tools.tool_implementations.mcp.mcp_client import discover_mcp_tools
from callosum.tools.tool_implementations.mcp.mcp_client import initialize_mcp_client
from callosum.tools.tool_implementations.mcp.mcp_client import log_exception_group
...
class CallosumTokenStorage(TokenStorage):
    """
...
def make_oauth_provider(
    ...
    return OAuthClientProvider(
        ...
        storage=CallosumTokenStorage(connection_config_id, admin_config_id),
