from callosum.configs.app_configs import DISABLE_USER_KNOWLEDGE
from callosum.configs.app_configs import CALLOSUM_QUERY_HISTORY_TYPE
from callosum.configs.app_configs import SHOW_EXTRA_CONNECTORS
from callosum.configs.constants import KV_SETTINGS_KEY
...
def load_settings() -> Settings:
    ...
    try:
        ...
        if value is not None:
            ...
            redis_client.set(
                CallosumRedisLocks.ANONYMOUS_USER_ENABLED, "0", ex=SETTINGS_TTL
            )
    except Exception as e:
    ...
    settings.query_history_type = CALLOSUM_QUERY_HISTORY_TYPE
...
def store_settings(settings: Settings) -> None:
    ...
    if settings.anonymous_user_enabled is not None:
        redis_client.set(
            CallosumRedisLocks.ANONYMOUS_USER_ENABLED,
