...
from callosum.db.constants import SLACK_BOT_PERSONA_PREFIX
...
from callosum.db.slack_bot import insert_slack_bot
from callosum.db.slack_bot import remove_slack_bot
from callosum.db.slack_bot import update_slack_bot
from callosum.db.slack_channel_config import create_slack_channel_persona
from callosum.db.slack_channel_config import fetch_slack_channel_config
from callosum.db.slack_channel_config import fetch_slack_channel_configs
from callosum.db.slack_channel_config import insert_slack_channel_config
from callosum.db.slack_channel_config import remove_slack_channel_config
from callosum.db.slack_channel_config import update_slack_channel_config
from callosum.callosumbot.slack.config import validate_channel_name
from callosum.server.manage.models import SlackBot
from callosum.server.manage.models import SlackBotCreationRequest
from callosum.server.manage.models import SlackChannelConfig
from callosum.server.manage.models import SlackChannelConfigCreationRequest
from callosum.server.manage.validate_tokens import validate_app_token
from callosum.server.manage.validate_tokens import validate_bot_token
from callosum.server.manage.validate_tokens import validate_user_token
...
def _form_channel_config(
    ...
    if respond_tag_only and respond_member_group_list:
        raise ValueError(
            "Cannot set CallosumBot to only respond to tags only and "
    ...
    if (
        ...
        raise ValueError(
            "Cannot set CallosumBot to respond to users in a private (ephemeral) message "
...
def create_bot(
    ...
    mt_cloud_telemetry(
        ...
        event=MilestoneRecordType.CREATED_CALLOSUM_BOT,
    )
