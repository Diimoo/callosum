...
from callosum.auth.users import user_needs_to_be_verified
from callosum.configs.app_configs import AUTH_TYPE
from callosum.configs.app_configs import PASSWORD_MIN_LENGTH
from callosum.configs.constants import DEV_VERSION_PATTERN
from callosum.configs.constants import STABLE_VERSION_PATTERN
from callosum.server.manage.models import AllVersions
from callosum.server.manage.models import AuthTypeResponse
from callosum.server.manage.models import ContainerVersions
from callosum.server.manage.models import VersionResponse
...
def get_versions() -> AllVersions:
    """
    Fetches the latest stable and beta versions of Callosum Docker images.
    ...
    """
    # Fetch the latest tags from DockerHub for each Callosum component
    dockerhub_repos = [
        "callosumdotapp/callosum-model-server",
        "callosumdotapp/callosum-backend",
        "callosumdotapp/callosum-web-server",
    ]
