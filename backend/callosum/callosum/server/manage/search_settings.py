...
from callosum.context.search.models import SearchSettingsCreationRequest
...
from callosum.db.search_settings import create_search_settings
from callosum.db.search_settings import delete_search_settings
from callosum.db.search_settings import get_current_search_settings
from callosum.db.search_settings import get_embedding_provider_from_provider_type
...
from callosum.db.search_settings import update_search_settings_status
...
from callosum.file_processing.unstructured import delete_unstructured_api_key
from callosum.file_processing.unstructured import get_unstructured_api_key
from callosum.file_processing.unstructured import update_unstructured_api_key
from callosum.natural_language_processing.search_nlp_models import clean_model_name
from callosum.server.manage.embedding.models import SearchSettingsDeleteRequest
from callosum.server.manage.models import FullModelVersionResponse
from callosum.server.models import IdReturn
...
def set_new_search_settings(
    ...
    if MULTI_TENANT and search_settings_new.enable_contextual_rag:
        raise HTTPException(
            ...
            detail="Contextual RAG disabled in Callosum Cloud",
        )
