...
from callosum.server.manage.llm.utils import DYNAMIC_LLM_PROVIDERS
from callosum.server.manage.llm.utils import extract_vendor_from_model_name
from callosum.server.manage.llm.utils import filter_model_configurations
...
class LLMProviderDescriptor(BaseModel):
    ...
    def from_model(
        ...
        from callosum.llm.llm_provider_options import get_provider_display_name
