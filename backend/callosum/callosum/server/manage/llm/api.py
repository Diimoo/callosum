...
from callosum.db.llm import can_user_access_llm_provider
from callosum.db.llm import fetch_existing_llm_provider
from callosum.db.llm import fetch_existing_llm_providers
from callosum.db.llm import fetch_persona_with_groups
from callosum.db.llm import fetch_user_group_ids
from callosum.db.llm import remove_llm_provider
from callosum.db.llm import sync_model_configurations
from callosum.db.llm import update_default_provider
from callosum.db.llm import update_default_vision_provider
from callosum.db.llm import upsert_llm_provider
from callosum.db.llm import validate_persona_ids_exist
from callosum.db.models import User
from callosum.db.persona import user_can_access_persona
from callosum.llm.factory import get_default_llm
from callosum.llm.factory import get_llm
from callosum.llm.factory import get_max_input_tokens_from_llm_provider
from callosum.llm.llm_provider_options import fetch_available_well_known_llms
from callosum.llm.llm_provider_options import WellKnownLLMProviderDescriptor
from callosum.llm.utils import get_bedrock_token_limit
from callosum.llm.utils import get_llm_contextual_cost
from callosum.llm.utils import model_supports_image_input
from callosum.llm.utils import test_llm
from callosum.server.manage.llm.models import BedrockFinalModelResponse
from callosum.server.manage.llm.models import BedrockModelsRequest
from callosum.server.manage.llm.models import LLMCost
from callosum.server.manage.llm.models import LLMProviderDescriptor
...
from callosum.server.manage.llm.models import OllamaFinalModelResponse
from callosum.server.manage.llm.models import OllamaModelDetails
from callosum.server.manage.llm.models import OllamaModelsRequest
from callosum.server.manage.llm.models import OpenRouterFinalModelResponse
from callosum.server.manage.llm.models import OpenRouterModelDetails
from callosum.server.manage.llm.models import OpenRouterModelsRequest
from callosum.server.manage.llm.models import TestLLMRequest
from callosum.server.manage.llm.models import VisionProviderResponse
from callosum.server.manage.llm.utils import generate_bedrock_display_name
from callosum.server.manage.llm.utils import generate_ollama_display_name
from callosum.server.manage.llm.utils import infer_vision_support
from callosum.server.manage.llm.utils import is_valid_bedrock_model
from callosum.server.manage.llm.utils import ModelMetadata
from callosum.server.manage.llm.utils import strip_openrouter_vendor_prefix
...
def _get_openrouter_models_response(api_base: str, api_key: str) -> dict:
    ...
    headers = {
        ...
        "HTTP-Referer": "https://callosum.app",
        "X-Title": "Callosum",
    }
    try:
