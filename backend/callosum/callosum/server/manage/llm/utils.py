...
from callosum.llm.constants import BEDROCK_MODEL_NAME_MAPPINGS
from callosum.llm.constants import OLLAMA_MODEL_NAME_MAPPINGS
from callosum.llm.constants import OLLAMA_MODEL_TO_VENDOR
...
def filter_model_configurations(
    ...
    from callosum.llm.llm_provider_options import is_obsolete_model
