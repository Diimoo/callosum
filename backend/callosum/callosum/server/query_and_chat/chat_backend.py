...
from callosum.chat.chat_utils import create_chat_history_chain
from callosum.chat.chat_utils import extract_headers
from callosum.chat.process_message import stream_chat_message
from callosum.chat.prompt_utils import get_default_base_system_prompt
from callosum.chat.stop_signal_checker import set_fence
from callosum.configs.app_configs import WEB_DOMAIN
from callosum.configs.chat_configs import HARD_DELETE_CHATS
from callosum.configs.constants import MessageType
from callosum.configs.constants import MilestoneRecordType
from callosum.configs.model_configs import LITELLM_PASS_THROUGH_HEADERS
from callosum.db.chat import add_chats_to_session_from_slack_thread
from callosum.db.chat import create_chat_session
from callosum.db.chat import create_new_chat_message
from callosum.db.chat import delete_all_chat_sessions_for_user
from callosum.db.chat import delete_chat_session
from callosum.db.chat import duplicate_chat_session_for_user_from_slack
from callosum.db.chat import get_chat_message
from callosum.db.chat import get_chat_messages_by_session
from callosum.db.chat import get_chat_session_by_id
from callosum.db.chat import get_chat_sessions_by_user
from callosum.db.chat import get_or_create_root_message
from callosum.db.chat import set_as_latest_chat_message
from callosum.db.chat import translate_db_message_to_chat_message_detail
from callosum.db.chat import update_chat_session
from callosum.db.chat_search import search_chat_sessions
from callosum.db.engine.sql_engine import get_session
from callosum.db.feedback import create_chat_message_feedback
from callosum.db.feedback import create_doc_retrieval_feedback
from callosum.db.feedback import remove_chat_message_feedback
...
from callosum.db.projects import check_project_ownership
from callosum.db.user_file import get_file_id_by_user_file_id
from callosum.file_processing.extract_file_text import docx_to_txt_filename
from callosum.file_store.file_store import get_default_file_store
from callosum.llm.factory import get_default_llm
from callosum.llm.factory import get_llm_for_persona
from callosum.llm.factory import get_llm_token_counter
...
from callosum.secondary_llm_flows.chat_session_naming import (
    get_renamed_conversation_name,
)
from callosum.server.query_and_chat.models import ChatFeedbackRequest
from callosum.server.query_and_chat.models import ChatMessageIdentifier
from callosum.server.query_and_chat.models import ChatRenameRequest
from callosum.server.query_and_chat.models import ChatSearchResponse
from callosum.server.query_and_chat.models import ChatSessionCreationRequest
from callosum.server.query_and_chat.models import ChatSessionDetailResponse
from callosum.server.query_and_chat.models import ChatSessionDetails
from callosum.server.query_and_chat.models import ChatSessionGroup
from callosum.server.query_and_chat.models import ChatSessionsResponse
from callosum.server.query_and_chat.models import ChatSessionSummary
from callosum.server.query_and_chat.models import ChatSessionUpdateRequest
from callosum.server.query_and_chat.models import CreateChatMessageRequest
from callosum.server.query_and_chat.models import CreateChatSessionID
from callosum.server.query_and_chat.models import LLMOverride
from callosum.server.query_and_chat.models import PromptOverride
from callosum.server.query_and_chat.models import RenameChatSessionResponse
from callosum.server.query_and_chat.models import SearchFeedbackRequest
from callosum.server.query_and_chat.models import UpdateChatSessionTemperatureRequest
from callosum.server.query_and_chat.models import UpdateChatSessionThreadRequest
from callosum.server.query_and_chat.session_loading import (
    translate_assistant_message_to_packets,
)
from callosum.server.query_and_chat.streaming_models import Packet
from callosum.server.query_and_chat.token_limit import check_token_rate_limits
from callosum.utils.headers import get_custom_tool_additional_request_headers
...
async def search_chats(
    ...
    chat_sessions, has_more = search_chat_sessions(
        ...
        page_size=page_size,
        include_deleted=False,
        include_callosumbot_flows=False,
    )
