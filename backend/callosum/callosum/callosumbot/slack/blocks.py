...
from callosum.configs.callosumbot_configs import CALLOSUM_BOT_NUM_DOCS_TO_DISPLAY
from callosum.context.search.models import SearchDoc
from callosum.db.chat import get_chat_session_by_message_id
from callosum.db.engine.sql_engine import get_session_with_current_tenant
from callosum.db.models import ChannelConfig
from callosum.callosumbot.slack.constants import CONTINUE_IN_WEB_UI_ACTION_ID
...
from callosum.callosumbot.slack.formatting import format_slack_message
from callosum.callosumbot.slack.icons import source_to_github_img_link
from callosum.callosumbot.slack.models import ActionValuesEphemeralMessage
from callosum.callosumbot.slack.models import ActionValuesEphemeralMessageChannelConfig
from callosum.callosumbot.slack.models import ActionValuesEphemeralMessageMessageInfo
from callosum.callosumbot.slack.models import SlackMessageInfo
from callosum.callosumbot.slack.utils import build_continue_in_web_ui_id
from callosum.callosumbot.slack.utils import build_feedback_id
from callosum.callosumbot.slack.utils import build_publish_ephemeral_message_id
from callosum.callosumbot.slack.utils import remove_slack_text_interactions
from callosum.callosumbot.slack.utils import translate_vespa_highlight_to_slack
from callosum.utils.text_processing import decode_escapes
...
def _build_documents_blocks(
    ...
    message_id: int | None,
    num_docs_to_display: int = CALLOSUM_BOT_NUM_DOCS_TO_DISPLAY,
) -> list[Block]:
        ...
        return ActionsBlock(
            ...
            elements=[
                ButtonElement(
                    ...
                    text="Continue Chat in Callosum!",
                    style="primary",
...
def build_slack_response_blocks(
    ...
    """
    # If called with the CallosumBot slash command, the question is lost so we have to reshow it
