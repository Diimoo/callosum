...
from callosum.chat.process_message import gather_stream_for_slack
...
from callosum.configs.callosumbot_configs import DANSWER_BOT_DISABLE_DOCS_ONLY_ANSWER
from callosum.configs.callosumbot_configs import DANSWER_BOT_DISPLAY_ERROR_MSGS
from callosum.configs.callosumbot_configs import DANSWER_BOT_NUM_RETRIES
from callosum.configs.callosumbot_configs import DANSWER_FOLLOWUP_EMOJI
from callosum.configs.callosumbot_configs import DANSWER_REACT_EMOJI
...
from callosum.callosumbot.slack.handlers.utils import slackify_message_thread
...
def handle_regular_answer(
    ...
    def _get_slack_answer(
        new_message_request: CreateChatMessageRequest, callosum_user: User | None
    ...
    try:
        ...
        answer = _get_slack_answer(new_message_request=answer_request, callosum_user=user)
