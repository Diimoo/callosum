...
from callosum.tools.tool_implementations.custom.base_tool_types import ToolResultType
...
class CallosumAnswerPiece(BaseModel):
...
class CallosumContext(BaseModel):
    content: str
    document_id: str
    semantic_identifier: str
    blurb: str
...
class CallosumContexts(BaseModel):
    contexts: list[CallosumContext]


class CallosumAnswer(BaseModel):
    answer: str | None
...
class ChatCallosumBotResponse(BaseModel):
