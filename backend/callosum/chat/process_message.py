...
from callosum.chat.answer import Answer
from callosum.chat.chat_utils import create_chat_chain
from callosum.chat.chat_utils import create_temporary_persona
from callosum.chat.models import AllCitations
from callosum.chat.models import AnswerStyleConfig
from callosum.chat.models import ChatCallosumBotResponse
from callosum.chat.models import CitationConfig
from callosum.chat.models import CitationInfo
from callosum.chat.models import CustomToolResponse
from callosum.chat.models import DocumentPruningConfig
from callosum.chat.models import FileChatDisplay
from callosum.chat.models import FinalUsedContextDocsResponse
from callosum.chat.models import LLMRelevanceFilterResponse
from callosum.chat.models import MessageResponseIDInfo
from callosum.chat.models import MessageSpecificCitations
from callosum.chat.models import CallosumAnswerPiece
from callosum.chat.models import CallosumContexts
from callosum.chat.models import PromptConfig
from callosum.chat.models import QADocsResponse
from callosum.chat.models import StreamingError
from callosum.chat.models import StreamStopInfo
from callosum.configs.chat_configs import CHAT_TARGET_CHUNK_PERCENTAGE
from callosum.configs.chat_configs import DISABLE_LLM_CHOOSE_SEARCH
from callosum.configs.chat_configs import MAX_CHUNKS_FED_TO_CHAT
from callosum.configs.constants import MessageType
from callosum.configs.constants import MilestoneRecordType
from callosum.configs.constants import NO_AUTH_USER_ID
from callosum.context.search.enums import OptionalSearchSetting
from callosum.context.search.enums import QueryFlow
from callosum.context.search.enums import SearchType
from callosum.context.search.models import InferenceSection
from callosum.context.search.models import RetrievalDetails
from callosum.context.search.retrieval.search_runner import inference_sections_from_ids
from callosum.context.search.utils import chunks_or_sections_to_search_docs
from callosum.context.search.utils import dedupe_documents
from callosum.context.search.utils import drop_llm_indices
from callosum.context.search.utils import relevant_sections_to_indices
from callosum.db.chat import attach_files_to_chat_message
from callosum.db.chat import create_db_search_doc
from callosum.db.chat import create_new_chat_message
from callosum.db.chat import get_chat_message
from callosum.db.chat import get_chat_session_by_id
from callosum.db.chat import get_db_search_doc_by_id
from callosum.db.chat import get_doc_query_identifiers_from_model
from callosum.db.chat import get_or_create_root_message
from callosum.db.chat import reserve_message_id
from callosum.db.chat import translate_db_message_to_chat_message_detail
from callosum.db.chat import translate_db_search_doc_to_server_search_doc
from callosum.db.engine import get_session_context_manager
from callosum.db.milestone import check_multi_assistant_milestone
from callosum.db.milestone import create_milestone_if_not_exists
from callosum.db.milestone import update_user_assistant_milestone
from callosum.db.models import SearchDoc as DbSearchDoc
from callosum.db.models import ToolCall
...
from callosum.file_store.utils import load_all_chat_files
from callosum.file_store.utils import save_files
from callosum.llm.exceptions import GenAIDisabledException
from callosum.llm.factory import get_llms_for_persona
from callosum.llm.factory import get_main_llm_from_tuple
from callosum.llm.models import PreviousMessage
from callosum.llm.utils import litellm_exception_to_error_msg
from callosum.natural_language_processing.utils import get_tokenizer
...
from callosum.server.utils import get_json_line
from callosum.tools.force import ForceUseTool
from callosum.tools.models import ToolResponse
from callosum.tools.tool import Tool
from callosum.tools.tool_constructor import construct_tools
from callosum.tools.tool_constructor import CustomToolConfig
from callosum.tools.tool_constructor import ImageGenerationToolConfig
from callosum.tools.tool_constructor import InternetSearchToolConfig
from callosum.tools.tool_constructor import SearchToolConfig
from callosum.tools.tool_implementations.custom.custom_tool import (
    CUSTOM_TOOL_RESPONSE_ID,
)
from callosum.tools.tool_implementations.custom.custom_tool import CustomToolCallSummary
from callosum.tools.tool_implementations.images.image_generation_tool import (
    IMAGE_GENERATION_RESPONSE_ID,
)
from callosum.tools.tool_implementations.images.image_generation_tool import (
    ImageGenerationResponse,
)
from callosum.tools.tool_implementations.internet_search.internet_search_tool import (
...
from callosum.tools.tool_implementations.search.search_tool import (
    FINAL_CONTEXT_DOCUMENTS_ID,
)
from callosum.tools.tool_implementations.search.search_tool import SEARCH_DOC_CONTENT_ID
from callosum.tools.tool_implementations.search.search_tool import (
    SEARCH_RESPONSE_SUMMARY_ID,
)
from callosum.tools.tool_implementations.search.search_tool import SearchResponseSummary
from callosum.tools.tool_implementations.search.search_tool import SearchTool
from callosum.tools.tool_implementations.search.search_tool import (
    SECTION_RELEVANCE_LIST_ID,
)
from callosum.tools.tool_runner import ToolCallFinalResult
from callosum.utils.logger import setup_logger
from callosum.utils.long_term_log import LongTermLogger
from callosum.utils.telemetry import mt_cloud_telemetry
from callosum.utils.timing import log_function_time
from callosum.utils.timing import log_generator_function_time
        ...
        for packet in answer.processed_streamed_output:
            if isinstance(packet, ToolResponse):
                if packet.id == SEARCH_RESPONSE_SUMMARY_ID:
                    ...
                    yield cast(CallosumContexts, packet.response)
...
) -> ChatCallosumBotResponse:
    response = ChatCallosumBotResponse()
