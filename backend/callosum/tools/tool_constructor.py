...
from callosum.configs.app_configs import AZURE_DALLE_API_BASE
from callosum.configs.app_configs import AZURE_DALLE_API_KEY
from callosum.configs.app_configs import AZURE_DALLE_API_VERSION
from callosum.configs.app_configs import AZURE_DALLE_DEPLOYMENT_NAME
from callosum.configs.chat_configs import BING_API_KEY
...
from callosum.tools.utils import compute_all_tool_tokens
from callosum.tools.utils import explicit_tool_calling_supported
...
class SearchToolConfig(BaseModel):
    ...
    # Use with care, should only be used for CallosumBot in channels with multiple users
    ...
    for db_tool_model in persona.tools:
        if db_tool_model.in_code_tool_id:
            ...
            # Handle Internet Search Tool
                ...
                if not BING_API_KEY:
                    raise ValueError(
                        "Internet search tool requires a Bing API key, please contact your Callosum admin to get it added!"
                    )
                tool_dict[db_tool_model.id] = [
                    InternetSearchTool(
