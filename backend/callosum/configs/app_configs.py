...
WEB_CONNECTOR_ALLOWED_DOMAINS = [
    domain.strip().lower()
    for domain in os.environ.get("WEB_CONNECTOR_ALLOWED_DOMAINS", "").split(",")
    if domain.strip()
]
WEB_CONNECTOR_BLOCKED_DOMAINS = [
    domain.strip().lower()
    for domain in os.environ.get("WEB_CONNECTOR_BLOCKED_DOMAINS", "").split(",")
    if domain.strip()
]
