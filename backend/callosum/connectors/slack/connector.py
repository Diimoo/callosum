...
from callosum.connectors.slack.utils import make_paginated_slack_api_call_w_retries
from callosum.connectors.slack.utils import make_slack_api_call_w_retries
...
def default_msg_filter(message: MessageType) -> bool:
    ...
    if message.get("bot_id") or message.get("app_id"):
        if message.get("bot_profile", {}).get("name") == "CallosumConnector":
            return False
        return True
