...
from callosum.file_processing.html_utils import strip_excessive_newlines_and_spaces
    ...
    def _process_entries(
        ...
        for library_entries in self._fetch_data(
            ...
            for entry in library_entries.get("items", []):
                ...
                # For Callosum, we decay document score overtime, either last_updated or
