...
from callosum.configs.app_configs import DISABLE_INDEX_UPDATE_ON_SWAP
from callosum.configs.app_configs import MANAGED_VESPA
from callosum.configs.app_configs import VESPA_NUM_ATTEMPTS_ON_STARTUP
from callosum.configs.constants import KV_REINDEX_KEY
from callosum.configs.constants import KV_SEARCH_SETTINGS
from callosum.configs.model_configs import FAST_GEN_AI_MODEL_VERSION
from callosum.configs.model_configs import GEN_AI_API_KEY
from callosum.configs.model_configs import GEN_AI_MODEL_VERSION
from callosum.context.search.models import SavedSearchSettings
from callosum.context.search.retrieval.search_runner import download_nltk_data
from callosum.db.connector import check_connectors_exist
from callosum.db.connector import create_initial_default_connector
from callosum.db.connector_credential_pair import associate_default_cc_pair
from callosum.db.connector_credential_pair import get_connector_credential_pairs
from callosum.db.connector_credential_pair import resync_cc_pair
from callosum.db.credentials import create_initial_public_credential
from callosum.db.document import check_docs_exist
from callosum.db.index_attempt import cancel_indexing_attempts_past_model
from callosum.db.index_attempt import expire_index_attempts
from callosum.db.llm import fetch_default_provider
from callosum.db.llm import update_default_provider
from callosum.db.llm import upsert_llm_provider
from callosum.db.persona import delete_old_default_personas
...
from callosum.db.search_settings import update_current_search_settings
from callosum.db.search_settings import update_secondary_search_settings
from callosum.db.swap_index import check_index_swap
...
from callosum.natural_language_processing.search_nlp_models import warm_up_cross_encoder
from callosum.seeding.load_docs import seed_initial_documents
from callosum.seeding.load_yamls import load_chat_yamls
from callosum.server.manage.llm.models import LLMProviderUpsertRequest
from callosum.server.settings.store import load_settings
from callosum.server.settings.store import store_settings
from callosum.tools.built_in_tools import auto_add_search_tool_to_personas
from callosum.tools.built_in_tools import load_builtin_tools
from callosum.tools.built_in_tools import refresh_built_in_tools_cache
from callosum.utils.gpu_utils import gpu_status_request
...
def setup_callosum(
    ...
    """
    Setup Callosum for a particular tenant. In the Single Tenant case, it will set it up for the default schema
...
def setup_multitenant_callosum() -> None:
