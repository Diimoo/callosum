...
from callosum.configs.app_configs import REDIS_AUTH_EXPIRE_TIME_SECONDS
...
from callosum.db.engine import get_async_session
from callosum.db.engine import get_async_session_with_tenant
...
async def optional_user(
    ...
    versioned_fetch_user = fetch_versioned_implementation(
        "callosum.auth.users", "optional_user_"
    )
