...
from callosum.configs.constants import KV_CUSTOMER_UUID_KEY
from callosum.configs.constants import KV_INSTANCE_DOMAIN_KEY
...
_DANSWER_TELEMETRY_ENDPOINT = "https://telemetry.callosum.app/anonymous_telemetry"
...
def optional_telemetry(
    ...
    try:
        ...
        # Should never interfere with normal functions of Callosum
        pass
...
def mt_cloud_telemetry(
    ...
    # This is only for Callosum MT Cloud, this code should also never be hit, no reason for any orgs to
    # be running the Multi Tenant version of Callosum.
    fetch_versioned_implementation_with_fallback(
        module="callosum.utils.telemetry",
