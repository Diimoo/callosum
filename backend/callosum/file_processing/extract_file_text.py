...
from callosum.configs.constants import DANSWER_METADATA_FILENAME
...
from callosum.file_store.file_store import FileStore
...
# To include additional metadata in the search index, add a .callosum_metadata.json file
...
def read_text_file(
    ...
    for ind, line in enumerate(file):
        ...
        if ind == 0:
            metadata_or_none = (
                None if ignore_callosum_metadata else _extract_callosum_metadata(line)
            )
