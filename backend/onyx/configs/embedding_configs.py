...
_BASE_EMBEDDING_MODELS = [
    # PRIMARY: Qwen3-Embedding via Ollama (state-of-the-art, MTEB #1)
    _BaseEmbeddingModel(
        name="qwen3-embedding",
        dim=4096,
        index_name="danswer_chunk_qwen3_embedding",
    ),
    # # Cloud-based models (commented out - using local Ollama model)
    # _BaseEmbeddingModel(
    ...
    # ),
    # # Self-hosted models (commented out - using local Ollama model)
    # _BaseEmbeddingModel(
    ...
    # ),
    # # State-of-the-art embedding models (8B class) - HuggingFace versions
    # _BaseEmbeddingModel(
