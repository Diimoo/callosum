...
PYTHONPATH=. python scripts/debugging/callosum_list_tenants.py

# Output as CSV (all on one line)
PYTHONPATH=. python scripts/debugging/callosum_list_tenants.py --csv

# Output as CSV batched into groups of 5
PYTHONPATH=. python scripts/debugging/callosum_list_tenants.py --csv -n 5
```
