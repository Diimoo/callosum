...
from ee.callosum.server.license.models import PlanType
from ee.callosum.utils.license import get_license_status
from ee.callosum.utils.license import is_license_valid
from ee.callosum.utils.license import verify_license_signature
from callosum.server.settings.models import ApplicationStatus
...
class TestVerifyLicenseSignature:
    ...
    def test_valid_signature(self) -> None:
        ...
        with patch("ee.callosum.utils.license.LICENSE_PUBLIC_KEY_PEM", public_key_pem):
    ...
    def test_invalid_signature(self) -> None:
        ...
        with patch(
            "ee.callosum.utils.license.LICENSE_PUBLIC_KEY_PEM",
