...
from callosum.connectors.gmail.connector import _build_time_range_query
from callosum.connectors.gmail.connector import GmailCheckpoint
from callosum.connectors.gmail.connector import GmailConnector
from callosum.connectors.gmail.connector import thread_to_document
...
def test_thread_to_document() -> None:
    ...
    doc = thread_to_document(full_email_thread, "admin@callosum-test.com")
...
def test_gmail_checkpoint_progression() -> None:
    ...
    with patch.object(GmailConnector, "_get_all_user_emails", return_value=user_emails):
        with patch(
            "callosum.connectors.gmail.connector.get_gmail_service",
            side_effect=fake_get_gmail_service,
        ):
            with patch(
                "callosum.connectors.gmail.connector.thread_to_document",
