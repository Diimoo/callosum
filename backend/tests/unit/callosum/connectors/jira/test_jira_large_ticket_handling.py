...
from callosum.connectors.jira.connector import _perform_jql_search
from callosum.connectors.jira.connector import process_jira_issue
...
def mock_jira_api_version() -> Generator[Any, Any, Any]:
    with patch("callosum.connectors.jira.utils.JIRA_CLOUD_API_VERSION", "3"):
        with patch("callosum.connectors.jira.utils.JIRA_SERVER_API_VERSION", "2"):
            yield
...
@patch("callosum.connectors.jira.connector.JIRA_CONNECTOR_MAX_TICKET_SIZE", 50)
