...
@pytest.fixture
def confluence_server_client(mock_credentials_provider: mock.Mock) -> CallosumConfluence:
    confluence = CallosumConfluence(
        is_cloud=False,
...
def test_cql_paginate_all_expansions_handles_internal_pagination_error(
    confluence_server_client: CallosumConfluence, caplog: pytest.LogCaptureFixture
) -> None:
    """
...
def test_paginated_cql_retrieval_cloud_no_retry_on_error(
    ...
    confluence_cloud_client = CallosumConfluence(
