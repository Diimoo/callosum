...
from callosum.connectors.factory import _connector_cache
from callosum.connectors.factory import _load_connector_class
from callosum.connectors.factory import ConnectorMissingException
from callosum.connectors.factory import identify_connector_class
...
from callosum.connectors.registry import CONNECTOR_CLASS_MAP
from callosum.connectors.registry import ConnectorMapping
...
class TestConnectorClassLoading:
    ...
    def test_load_connector_class_import_error(self, mock_import: Mock) -> None:
        ...
        assert (
            "Failed to import WebConnector from callosum.connectors.web.connector"
    ...
    def test_mapping_format_consistency(self) -> None:
        ...
        for source, mapping in CONNECTOR_CLASS_MAP.items():
            ...
            assert mapping.module_path.startswith(
                "callosum.connectors."
            ), f"{source.value} module_path doesn't start with callosum.connectors."
