...
from callosum.connectors.zendesk.connector import ZendeskClient
...
def test_load_from_checkpoint_with_rate_limit(
    ...
    with patch("callosum.connectors.zendesk.connector.requests.get") as mock_get:
        ...
        # Call load_from_checkpoint
        end_time = time.time()
        with patch("callosum.connectors.zendesk.connector.time.sleep") as mock_sleep:
