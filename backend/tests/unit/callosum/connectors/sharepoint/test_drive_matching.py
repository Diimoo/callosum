...
from callosum.connectors.sharepoint.connector import SHARED_DOCUMENTS_MAP
from callosum.connectors.sharepoint.connector import SharepointConnector
from callosum.connectors.sharepoint.connector import SharepointConnectorCheckpoint
from callosum.connectors.sharepoint.connector import SiteDescriptor
...
def test_load_from_checkpoint_maps_drive_name(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "callosum.connectors.sharepoint.connector._convert_driveitem_to_document_with_permissions",
        fake_convert,
    )
