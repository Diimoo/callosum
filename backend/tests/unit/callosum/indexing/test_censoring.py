...
_post_query_chunk_censoring = fetch_ee_implementation_or_noop(
    "callosum.external_permissions.post_query_censoring", "_post_query_chunk_censoring"
)
...
class TestPostQueryChunkCensoring:
    ...
    @patch(
        "ee.callosum.external_permissions.post_query_censoring._get_all_censoring_enabled_sources"
    )
    ...
    @patch(
        "ee.callosum.external_permissions.post_query_censoring.DOC_SOURCE_TO_CHUNK_CENSORING_FUNCTION"
    )
