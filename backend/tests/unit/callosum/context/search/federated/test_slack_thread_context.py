...
from callosum.context.search.federated.slack_search import _fetch_thread_context
from callosum.context.search.federated.slack_search import (
    fetch_thread_contexts_with_rate_limit_handling,
)
from callosum.context.search.federated.slack_search import SlackRateLimitError
from callosum.context.search.federated.slack_search import ThreadContextResult
...
class TestFetchThreadContext:
    ...
    @patch("callosum.context.search.federated.slack_search.batch_get_user_profiles")
    @patch("callosum.context.search.federated.slack_search.WebClient")
...
class TestFetchThreadContextsWithRateLimitHandling:
    ...
    @patch("callosum.context.search.federated.slack_search._fetch_thread_context")
    @patch(
        "callosum.context.search.federated.slack_search.run_functions_tuples_in_parallel"
    )
