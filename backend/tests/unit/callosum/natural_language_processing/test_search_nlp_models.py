...
from callosum.natural_language_processing.search_nlp_models import CloudEmbedding
...
async def test_rate_limit_handling() -> None:
    with patch(
        "callosum.natural_language_processing.search_nlp_models.CloudEmbedding.embed"
    ) as mock_embed:
