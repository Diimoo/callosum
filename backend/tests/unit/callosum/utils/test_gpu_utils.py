"""
Test cases for callosum/utils/gpu_utils.py with DISABLE_MODEL_SERVER environment variable
"""
...
from callosum.utils.gpu_utils import _get_gpu_status_from_model_server
