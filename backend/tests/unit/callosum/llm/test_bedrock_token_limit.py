...
class TestGetBedrockTokenLimit:
    ...
    def test_litellm_lookup_with_bedrock_prefix(self) -> None:
        ...
        with patch("callosum.llm.utils.get_model_map", return_value=mock_model_map):
    ...
    def test_hardcoded_mapping_claude_3_5(self) -> None:
        ...
        with patch("callosum.llm.utils.get_model_map", return_value={}):
    ...
    def test_litellm_exception_falls_through(self) -> None:
        ...
        with patch(
            "callosum.llm.utils.get_model_map", side_effect=Exception("LiteLLM error")
        ):
