...
from callosum.federated_connectors.factory import _federated_connector_cache
from callosum.federated_connectors.factory import _load_federated_connector_class
from callosum.federated_connectors.factory import FederatedConnectorMissingException
...
from callosum.federated_connectors.registry import FEDERATED_CONNECTOR_CLASS_MAP
from callosum.federated_connectors.registry import FederatedConnectorMapping
    ...
    def test_mapping_format_consistency(self) -> None:
        ...
        for source, mapping in FEDERATED_CONNECTOR_CLASS_MAP.items():
            ...
            assert mapping.module_path.startswith(
                "callosum.federated_connectors."
            ), f"{source.value} module_path doesn't start with callosum.federated_connectors."
...
class TestFederatedConnectorClassLoading:
    ...
    def test_load_federated_connector_class_import_error(
        ...
        assert (
            "Failed to import SlackFederatedConnector from callosum.federated_connectors.slack.federated_connector"
