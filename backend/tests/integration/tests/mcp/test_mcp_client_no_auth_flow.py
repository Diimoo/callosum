...
# NOTE: the tests for client should be independent of the Callosum MCP server
# This means the port should probably stay to be 8010/not 8090 the Callosum MCP server port
# Use MOCK_MCP_SERVER_PORT to avoid conflicts with the real Callosum MCP server port (8090)
