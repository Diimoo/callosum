...
def slack_connector(
    ...
    slack_credentials_provider: CallosumStaticCredentialsProvider,
...
@pytest.fixture
def slack_credentials_provider() -> CallosumStaticCredentialsProvider:
    CI_ENV_VAR = "SLACK_BOT_TOKEN"
    LOCAL_ENV_VAR = "CALLOSUM_BOT_SLACK_BOT_TOKEN"
    ...
    return CallosumStaticCredentialsProvider(
