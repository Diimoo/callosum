...
from tests.unit.callosum.connectors.utils import load_everything_from_checkpoint_connector
...
This thread was 4 emails long:
    admin@callosum-test.com -> test-group-1@callosum-test.com (conaining test_user_1 and test_user_2)
    test_user_1@callosum-test.com -> admin@callosum-test.com
    admin@callosum-test.com -> test_user_2@callosum-test.com + BCC: test_user_3@callosum-test.com
    test_user_3@callosum-test.com -> admin@callosum-test.com
"""
_THREAD_1_BY_ID: dict[str, dict[str, Any]] = {
    "192edefb315737c3": {
        "email": "admin@callosum-test.com",
        "sections_count": 4,
        "primary_owners": set(
            [
                "admin@callosum-test.com",
                "test_user_1@callosum-test.com",
                "test_user_3@callosum-test.com",
            ]
        ),
        "secondary_owners": set(
            [
                "test-group-1@callosum-test.com",
                "admin@callosum-test.com",
                "test_user_2@callosum-test.com",
                "test_user_3@callosum-test.com",
            ]
        ),
    },
    "192edf020d2f5def": {
        "email": "test_user_1@callosum-test.com",
        "sections_count": 2,
        "primary_owners": set(["admin@callosum-test.com", "test_user_1@callosum-test.com"]),
        "secondary_owners": set(["test-group-1@callosum-test.com", "admin@callosum-test.com"]),
    },
    "192edf020ae90aab": {
        "email": "test_user_2@callosum-test.com",
        "sections_count": 2,
        "primary_owners": set(["admin@callosum-test.com"]),
        "secondary_owners": set(
            ["test-group-1@callosum-test.com", "test_user_2@callosum-test.com"]
        ),
    },
    "192edf18316015fa": {
        "email": "test_user_3@callosum-test.com",
        "sections_count": 2,
        "primary_owners": set(["admin@callosum-test.com", "test_user_3@callosum-test.com"]),
        "secondary_owners": set(
            [
                "admin@callosum-test.com",
                "test_user_2@callosum-test.com",
