...
from callosum.db._deprecated.pg_file_store import delete_lobj_by_id, read_lobj
from callosum.file_store.file_store import get_s3_file_store
...
def _migrate_files_to_postgres() -> None:
    ...
    for i, file_id in enumerate(files_to_migrate, 1):
        ...
        try:
            ...
            from callosum.db._deprecated.pg_file_store import (
