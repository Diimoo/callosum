...
from ee.callosum.configs.app_configs import OAUTH_CONFLUENCE_CLIENT_ID
from ee.callosum.configs.app_configs import OAUTH_CONFLUENCE_CLIENT_SECRET
from ee.callosum.configs.app_configs import OAUTH_GOOGLE_DRIVE_CLIENT_ID
from ee.callosum.configs.app_configs import OAUTH_GOOGLE_DRIVE_CLIENT_SECRET
from ee.callosum.configs.app_configs import OAUTH_SLACK_CLIENT_ID
from ee.callosum.configs.app_configs import OAUTH_SLACK_CLIENT_SECRET
...
from callosum.connectors.google_utils.google_auth import get_google_oauth_creds
from callosum.connectors.google_utils.google_auth import sanitize_oauth_credentials
...
class SlackOAuth:
    ...
    # SCOPE is per https://docs.callosum.app/connectors/slack
    BOT_SCOPE = (
        "channels:history,"
        "channels:read,"
        "groups:history,"
...
class GoogleDriveOAuth:
    ...
    # SCOPE is per https://docs.callosum.app/connectors/google-drive
