...
from ee.callosum.configs.app_configs import SAML_CONF_DIR
from ee.callosum.db.saml import expire_saml_account
from ee.callosum.db.saml import get_saml_account
from ee.callosum.db.saml import upsert_saml_account
from ee.callosum.utils.secrets import encrypt_string
from ee.callosum.utils.secrets import extract_hashed_cookie
...
async def saml_login_callback(
    ...
    # Redirect to main Callosum search page
