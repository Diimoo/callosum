...
from ee.callosum.db.query_history import fetch_chat_sessions_eagerly_by_time
...
from ee.callosum.server.query_history.models import QuestionAnswerPairSnapshot
...
def get_query_history_as_csv(
    ...
    return StreamingResponse(
        ...
        media_type="text/csv",
        headers={"Content-Disposition": "attachment;filename=callosum_query_history.csv"},
    )
