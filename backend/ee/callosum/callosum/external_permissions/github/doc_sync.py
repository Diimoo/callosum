...
from ee.callosum.external_permissions.github.utils import fetch_repository_team_slugs
from ee.callosum.external_permissions.github.utils import form_collaborators_group_id
from ee.callosum.external_permissions.github.utils import form_organization_group_id
from ee.callosum.external_permissions.github.utils import (
    form_outside_collaborators_group_id,
)
from ee.callosum.external_permissions.github.utils import get_external_access_permission
from ee.callosum.external_permissions.github.utils import get_repository_visibility
from ee.callosum.external_permissions.github.utils import GitHubVisibility
...
from callosum.connectors.github.connector import DocMetadata
...
def _is_repo_visibility_changed_from_groups(
    ...
    collaborators_group_id = build_ext_group_name_for_callosum(
    ...
    if repo.organization:
        org_group_id = build_ext_group_name_for_callosum(
            source=DocumentSource.GITHUB,
...
def _teams_updated_from_groups(
    ...
    outside_collaborators_group_id = build_ext_group_name_for_callosum(
        source=DocumentSource.GITHUB,
    ...
    for team_slug in current_teams:
        team_group_id = build_ext_group_name_for_callosum(
            source=DocumentSource.GITHUB,
