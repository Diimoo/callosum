from ee.callosum.configs.app_configs import CONFLUENCE_ANONYMOUS_ACCESS_IS_PUBLIC
from ee.callosum.external_permissions.confluence.constants import ALL_CONF_EMAILS_GROUP_NAME
from ee.callosum.external_permissions.confluence.constants import REQUEST_PAGINATION_LIMIT
from ee.callosum.external_permissions.confluence.constants import VIEWSPACE_PERMISSION_TYPE
...
def _get_server_space_permissions(
    confluence_client: CallosumConfluence, space_key: str
) -> ExternalAccess:
