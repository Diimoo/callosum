...
from ee.callosum.external_permissions.jira.models import Holder
from ee.callosum.external_permissions.jira.models import Permission
from ee.callosum.external_permissions.jira.models import User
