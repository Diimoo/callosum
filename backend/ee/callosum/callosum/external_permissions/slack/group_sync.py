...
from ee.callosum.external_permissions.slack.utils import fetch_user_id_to_email_map
from callosum.connectors.credentials_provider import CallosumDBCredentialsProvider
from callosum.connectors.slack.connector import SlackConnector
...
def slack_group_sync(
    ...
    provider = CallosumDBCredentialsProvider(tenant_id, "slack", cc_pair.credential.id)
