...
from ee.callosum.background.task_name_builders import QUERY_HISTORY_TASK_NAME_PREFIX
from callosum.auth.users import get_display_email
from callosum.background.task_utils import extract_task_id_from_query_history_report_name
...
from callosum.db.models import TaskQueueState
...
class ChatSessionMinimal(BaseModel):
    ...
    def from_chat_session(cls, chat_session: ChatSession) -> "ChatSessionMinimal":
        ...
        return cls(
            ...
            flow_type=(
                SessionType.SLACK if chat_session.callosumbot_flow else SessionType.CHAT
            ),
