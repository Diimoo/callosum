...
from callosum.configs.constants import KV_CUSTOM_ANALYTICS_SCRIPT_KEY
from callosum.configs.constants import KV_ENTERPRISE_SETTINGS_KEY
...
def load_runtime_settings() -> EnterpriseSettings:
    ...
    if not enterprise_settings.application_name:
        enterprise_settings.application_name = CALLOSUM_DEFAULT_APPLICATION_NAME
