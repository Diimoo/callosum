...
from ee.callosum.configs.app_configs import GATED_TENANTS_KEY
...
def overwrite_full_gated_set(tenant_ids: list[str]) -> None:
    ...
    full_gated_set_key = f"{CALLOSUM_CLOUD_TENANT_ID}:{GATED_TENANTS_KEY}"
...
def get_gated_tenants() -> set[str]:
    redis_client = get_redis_replica_client(tenant_id=CALLOSUM_CLOUD_TENANT_ID)
