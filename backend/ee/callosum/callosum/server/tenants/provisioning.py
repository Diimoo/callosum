...
from ee.callosum.configs.app_configs import ANTHROPIC_DEFAULT_API_KEY
from ee.callosum.configs.app_configs import COHERE_DEFAULT_API_KEY
from ee.callosum.configs.app_configs import HUBSPOT_TRACKING_URL
from ee.callosum.configs.app_configs import OPENAI_DEFAULT_API_KEY
from ee.callosum.server.tenants.access import generate_data_plane_token
from ee.callosum.server.tenants.models import TenantByDomainResponse
from ee.callosum.server.tenants.models import TenantCreationPayload
from ee.callosum.server.tenants.models import TenantDeletionPayload
from ee.callosum.server.tenants.schema_management import create_schema_if_not_exists
from ee.callosum.server.tenants.schema_management import drop_schema
from ee.callosum.server.tenants.schema_management import run_alembic_migrations
from ee.callosum.server.tenants.user_mapping import add_users_to_tenant
from ee.callosum.server.tenants.user_mapping import get_tenant_id_for_email
from ee.callosum.server.tenants.user_mapping import user_owns_a_tenant
from callosum.auth.users import exceptions
from callosum.configs.app_configs import CONTROL_PLANE_API_BASE_URL
...
from callosum.db.llm import upsert_cloud_embedding_provider
from callosum.db.llm import upsert_llm_provider
from callosum.db.models import AvailableTenant
from callosum.db.models import IndexModelStatus
from callosum.db.models import SearchSettings
from callosum.db.models import UserTenantMapping
from callosum.llm.llm_provider_options import ANTHROPIC_PROVIDER_NAME
from callosum.llm.llm_provider_options import get_anthropic_model_names
from callosum.llm.llm_provider_options import get_openai_model_names
from callosum.llm.llm_provider_options import OPENAI_PROVIDER_NAME
from callosum.server.manage.embedding.models import CloudEmbeddingProviderCreationRequest
...
async def setup_tenant(tenant_id: str) -> None:
    ...
    try:
        ...
        with get_session_with_tenant(tenant_id=tenant_id) as db_session:
            ...
            # Set up Callosum with appropriate settings
            ...
            setup_callosum(db_session, tenant_id, cohere_enabled=cohere_enabled)
