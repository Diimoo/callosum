...
from ee.callosum.server.query_history.api import fetch_and_process_chat_session_history
from ee.callosum.server.query_history.api import CALLOSUM_ANONYMIZED_EMAIL
...
from callosum.db.tasks import delete_task_with_id
from callosum.db.tasks import mark_task_as_finished_with_id
from callosum.db.tasks import mark_task_as_started_with_id
...
@shared_task(
    name=CallosumCeleryTask.EXPORT_QUERY_HISTORY_TASK,
    ignore_result=True,
