...
from ee.callosum.db.external_perm import fetch_external_groups_for_user
from ee.callosum.db.external_perm import fetch_public_external_group_ids
from ee.callosum.db.user_group import fetch_user_groups_for_documents
from ee.callosum.db.user_group import fetch_user_groups_for_user
from ee.callosum.external_permissions.sync_params import get_source_perm_sync_config
from callosum.access.access import (
    _get_access_for_documents as get_access_for_documents_without_groups,
)
from callosum.access.access import _get_acl_for_user as get_acl_for_user_without_groups
from callosum.access.models import DocumentAccess
from callosum.access.utils import prefix_external_group
from callosum.access.utils import prefix_user_group
from callosum.db.document import get_document_sources
...
def _get_access_for_documents(
    ...
    for document_id, non_ee_access in non_ee_access_dict.items():
        ...
        # then it's given the same access level as if it were marked public within Callosum
...
def _get_acl_for_user(user: User | None, db_session: Session) -> set[str]:
    ...
    NOTE: is imported in callosum.access.access by `fetch_versioned_implementation`
    DO NOT REMOVE."""
