...
from ee.callosum.server.reporting.usage_export_models import ChatMessageSkeleton
from ee.callosum.server.reporting.usage_export_models import FlowType
...
from callosum.db.models import UsageReport
...
def get_empty_chat_messages_entries__paginated(
    ...
    for chat_session in chat_sessions:
        flow_type = FlowType.SLACK if chat_session.callosumbot_flow else FlowType.CHAT
