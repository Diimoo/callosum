...
SAML_CONF_DIR = os.environ.get("SAML_CONF_DIR") or "/app/ee/callosum/configs/saml_config"
...
# when the capture is called. These defaults prevent Posthog issues from breaking the Callosum app
