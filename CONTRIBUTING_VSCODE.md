...
3. From the dropdown at the top, select "Run All Callosum Services" and press the green play button
4. Now, you can navigate to callosum in your browser (default is http://localhost:3000) and start using the app
