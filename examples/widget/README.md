# Callosum Chat Bot Widget

Note: The widget requires a Callosum API key, which is a paid (cloud/enterprise) feature.

This is a code example for how you can use Callosum's APIs to build a chat bot widget for a website! The main code to look at can be found in `src/app/widget/Widget.tsx`.
...
If you want to get fancier, then take a peek at the Chat implementation within Callosum itself [here](https://github.com/callosum-dot-app/callosum/blob/main/web/src/app/chat/ChatPage.tsx#L82).
